(function(a, b) {
    function c(a, c, d) {
        if (d === b && 1 === a.nodeType) if (d = "data-" + c.replace(oc, "-$1").toLowerCase(), d = a.getAttribute(d), "string" == typeof d) {
            try {
    ...
    function l(a, b, c) {
        b = b || 0;
        if (g.isFunction(b)) return g.grep(a,
        function(a, x) {
            return !! b.call(a, x, a) === c
        });
        if (b.nodeType) return g.grep(a,
        function(a) {
            return a === b === c
        });
        if ("string" == typeof b) {
    ...
    function m(a, b) {
        if (1 === b.nodeType && g.hasData(a)) {
            ...
            var f = g._data(b, d),
            r = d.events;
            if (r) for (c in delete f.handle, f.events = {},
            r) {
                d = 0;
                for (e = r[c].length; d < e; d++) g.event.add(b, c, r[c][d])
            }
            f.data && (f.data = g.extend({},
            f.data))
        }
    }
    ...
    function k(a, b) {
        var c;
        1 === b.nodeType && (b.clearAttributes && b.clearAttributes(), b.mergeAttributes && b.mergeAttributes(a), c = b.nodeName.toLowerCase(), "object" === c ? (b.parentNode && (b.outerHTML = a.outerHTML), g.support.html5Clone && a.innerHTML && !g.trim(b.innerHTML) && (b.innerHTML = a.innerHTML)) : "input" === c && tb.test(a.type) ? (b.defaultChecked = b.checked = a.checked, b.value !== a.value && (b.value = a.value)) : "option" === c ? b.selected = a.defaultSelected: "input" === c || "textarea" === c ? b.defaultValue = a.defaultValue: "script" === c && b.text !== a.text && (b.text = a.text), b.removeAttribute(g.expando))
    }
    ...
    function u(a, b) {
        if (b in a) return b;
        for (var c = b.charAt(0).toUpperCase() + b.slice(1), d = b, g = ub.length; g--;) if (b = ub[g] + c, b in a) return b;
        return d
    }

    function y(a, b) {
        return a = b || a,
        "none" === g.css(a, "display") || !g.contains(a.ownerDocument, a)
    }

    function v(a, b) {
        for (var c, d, e = [], f = 0, r = a.length; f < r; f++) c = a[f],
        c.style && (e[f] = g._data(c, "olddisplay"), b ? (!e[f] && "none" === c.style.display && (c.style.display = ""), "" === c.style.display && y(c) && (e[f] = g._data(c, "olddisplay", K(c.nodeName)))) : (d = L(c, "display"), !e[f] && "none" !== d && g._data(c, "olddisplay", d)));
        for (f = 0; f < r; f++) if (c = a[f], c.style && (!b || "none" === c.style.display || "" === c.style.display)) c.style.display = b ? e[f] || "": "none";
        return a
    }
    ...
    function Ta(a, b, c, d) {
        ...
        for (var e = 0; 4 > b; b += 2)"margin" === c && (e += g.css(a, c + Z[b], !0)),
        d ? ("content" === c && (e -= parseFloat(L(a, "padding" + Z[b])) || 0), "margin" !== c && (e -= parseFloat(L(a, "border" + Z[b] + "Width")) || 0)) : (e += parseFloat(L(a, "padding" + Z[b])) || 0, "padding" !== c && (e += parseFloat(L(a, "border" + Z[b] + "Width")) || 0));
        return e
    }
    ...
    function K(a) {
        ...
        if ("none" === c || "" === c) {
            ...
            if (!ia || !ha.createElement) ia = (ha.contentWindow || ha.contentDocument).document,
            ia.write("<!doctype html><html><body>"),
            ia.close();
    ...
    function H(a, b, c, d) {
        var e;
        if (g.isArray(b)) g.each(b,
        function(b, C) {
            c || tc.test(a) ? d(a, C) : H(a + "[" + ("object" == typeof C ? b: "") + "]", C, c, d)
        });
        else if (!c && "object" === g.type(b)) for (e in b) H(a + "[" + e + "]", b[e], c, d);
        else d(a, b)
    }
    ...
    function va(a) {
        return function(b, c) {
            ...
            r = 0,
            j = f.length;
            if (g.isFunction(c)) for (; r < j; r++) d = f[r],
    ...
    function ja(a, c, d, g, e, f) {
        ...
        e = a[e];
        for (var j = 0,
        k = e ? e.length: 0, h = a === Va; j < k && (h || !r); j++) r = e[j](c, d, g),
        "string" == typeof r && (!h || f[r] ? r = b: (c.dataTypes.unshift(r), r = ja(a, c, d, g, r, f)));
        return (h || !r) && !f["*"] && (r = ja(a, c, d, g, "*", f)),
        r
    }
    ...
    function xb(a, b, c) {
        ...
        j = function() {
            for (var b = wa || wb(), b = Math.max(0, k.startTime + k.duration - b), c = 1 - (b / k.duration || 0), d = 0, C = k.tweens.length; d < C; d++) k.tweens[d].run(c);
            return r.notifyWith(a, [k, c, b]),
            1 > c && C ? b: (r.resolveWith(a, [k]), !1)
        },
        k = r.promise({
            elem: a,
            props: g.extend({},
            ...
            stop: function(b) {
                for (var c = 0,
                d = b ? k.tweens.length: 0; c < d; c++) k.tweens[c].run(1);
                return b ? r.resolveWith(a, [k, b]) : r.rejectWith(a, [k, b]),
                this
            }
        });
        b = k.props;
        ...
        var h, p, l, s;
        for (d in b) if (h = g.camelCase(d), p = c[h], l = b[d], g.isArray(l) && (p = l[1], l = b[d] = l[0]), d !== h && (b[h] = l, delete b[d]), (s = g.cssHooks[h]) && "expand" in s) for (d in l = s.expand(l), delete b[h], l) d in b || (b[d] = l[d], c[d] = p);
        else c[h] = p;
        for (; e < f; e++) if (d = xa[e].call(k, a, b, k.opts)) return d;
        var m = k;
        g.each(b,
        function(a, b) {
            for (var x = (pa[a] || []).concat(pa["*"]), c = 0, d = x.length; c < d && !x[c].call(m, a, b); c++);
        });
        return g.isFunction(k.opts.start) && k.opts.start.call(a, k),
        g.fx.timer(g.extend(j, {
            anim: k,
            queue: k.opts.queue,
            elem: a
        })),
    ...
    g.fn = g.prototype = {
        ...
        init: function(a, c, d) {
            ...
            if ("string" == typeof a) {
                ...
                if (e && (e[1] || !c)) {
                    if (e[1]) return c = c instanceof g ? c[0] : c,
                    f = c && c.nodeType ? c.ownerDocument || c: t,
                    a = g.parseHTML(e[1], f, !0),
                    Cb.test(e[1]) && g.isPlainObject(c) && this.attr.call(a, c, !0),
                    g.merge(this, a);
    ...
    g.extend = g.fn.extend = function() {
        ...
        j = arguments.length,
        h = !1;
        "boolean" == typeof r && (h = r, r = arguments[1] || {},
        k = 2);
        "object" != typeof r && !g.isFunction(r) && (r = {});
        for (j === k && (r = this, --k); k < j; k++) if (null != (a = arguments[k])) for (c in a) d = r[c],
        e = a[c],
        r !== e && (h && e && (g.isPlainObject(e) || (f = g.isArray(e))) ? (f ? (f = !1, G = d && g.isArray(d) ? d: []) : G = d && g.isPlainObject(d) ? d: {},
        r[c] = g.extend(h, G, e)) : e !== b && (r[c] = e));
        return r
    };
    g.extend({
        noConflict: function(b) {
            return a.$ === g && (a.$ = yc),
            b && a.jQuery === g && (a.jQuery = xc),
            g
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function(a) {
            if (! (!0 === a ? --g.readyWait: g.isReady)) {
                ...
                g.isReady = !0; ! 0 !== a && 0 < --g.readyWait || (za.resolveWith(t, [g]), g.fn.trigger && g(t).trigger("ready").off("ready"))
            }
        },
        ...
        type: function(a) {
            return null == a ? String(a) : Db[zc.call(a)] || "object"
        },
        ...
        parseHTML: function(a, b, c) {
            var d;
            return ! a || "string" != typeof a ? null: ("boolean" == typeof b && (c = b, b = 0), b = b || t, (d = Cb.exec(a)) ? [b.createElement(d[1])] : (d = g.buildFragment([a], b, c ? null: []), g.merge([], (d.cacheable ? g.clone(d.fragment) : d.fragment).childNodes)))
        },
        ...
        parseXML: function(c) {
            ...
            try {
                a.DOMParser ? (I = new DOMParser, d = I.parseFromString(c, "text/xml")) : (d = new ActiveXObject("Microsoft.XMLDOM"), d.async = "false", d.loadXML(c))
            } catch(e) {
                d = b
            }
            return (!d || !d.documentElement || d.getElementsByTagName("parsererror").length) && g.error("Invalid XML: " + c),
            d
        },
        noop: function() {},
        globalEval: function(b) {
            b && Ac.test(b) && (a.execScript ||
            function(b) {
                a.eval.call(a, b)
            })(b)
        },
        ...
        makeArray: function(a, b) {
            var c, d = b || [];
            return null != a && (c = g.type(a), null == a.length || "string" === c || "function" === c || "regexp" === c || g.isWindow(a) ? Ab.call(d, a) : g.merge(d, a)),
            d
        },
        ...
        merge: function(a, c) {
            ...
            g = a.length,
            e = 0;
            if ("number" == typeof d) for (; e < d; e++) a[g++] = c[e];
            else for (; c[e] !== b;) a[g++] = c[e++];
            return a.length = g,
            a
        },
        grep: function(a, b, c) {
        ...
        map: function(a, c, d) {
            ...
            r = 0,
            j = a.length;
            if (a instanceof g || j !== b && "number" == typeof j && (0 < j && a[0] && a[j - 1] || 0 === j || g.isArray(a))) for (; r < j; r++) e = c(a[r], r, d),
            null != e && (k[k.length] = e);
        ...
        proxy: function(a, c) {
            ...
            g.isFunction(a) ? (e = V.call(arguments, 2), f = function() {
        ...
        access: function(a, c, d, e, f, k, r) {
            ...
            if (d && "object" == typeof d) {
                ...
                if (c) for (; p < l; p++) c(a[p], d, j ? e.call(a[p], p, c(a[p], d)) : e, r);
                f = 1
            }
    ...
    g.ready.promise = function(b) {
        if (!za) if (za = g.Deferred(), "complete" === t.readyState) setTimeout(g.ready, 1);
        else if (t.addEventListener) t.addEventListener("DOMContentLoaded", Ba, !1),
        a.addEventListener("load", g.ready, !1);
        else {
            t.attachEvent("onreadystatechange", Ba);
    ...
    g.each("Boolean Number String Function Array Date RegExp Object".split(" "),
    function(a, b) {
    ...
    g.Callbacks = function(a) {
        ...
        s = function(b) {
            ...
            r = 0;
            j = p.length;
            for (k = !0; p && h < j; h++) if (!1 === p[h].apply(b[0], b[1]) && a.stopOnFalse) {
                e = !1;
                break
            }
            k = !1;
        ...
        m = {
            ...
            remove: function() {
                return p && g.each(arguments,
                function(a, b) {
                    for (var c; - 1 < (c = g.inArray(b, p, c));) p.splice(c, 1),
                    k && (c <= j && j--, c <= h && h--)
                }),
                this
            },
    ...
    g.extend({
        Deferred: function(a) {
            var b = [["resolve", "done", g.Callbacks("once memory"), "resolved"], ["reject", "fail", g.Callbacks("once memory"), "rejected"], ["notify", "progress", g.Callbacks("memory")]],
            c = "pending",
            d = {
                state: function() {
                    return c
        ...
        data: function(a, c, d, e) {
            if (g.acceptData(a)) {
                ...
                if (l && p[l] && (e || p[l].data) || !(j && d === b)) {
                    ...
                    d !== b && (f[g.camelCase(c)] = d),
                    j ? (k = f[c], null == k && (k = f[g.camelCase(c)])) : k = f,
                    k
                }
            }
        },
        ...
        data: function(a, d) {
            ...
            if (a === b) {
                if (this.length && (l = g.data(h), 1 === h.nodeType && !g._data(h, "parsedAttrs"))) {
                    k = h.attributes;
                    for (r = k.length; p < r; p++) j = k[p].name,
                    j.indexOf("data-") || (j = g.camelCase(j.substring(5)), c(h, j, l[j]));
            ...
            return "object" == typeof a ? this.each(function() {
                g.data(this, a)
            }) : (e = a.split(".", 2), e[1] = e[1] ? "." + e[1] : "", f = e[1] + "!", g.access(this,
            function(d) {
                if (d === b) return l = this.triggerHandler("getData" + f, [e[0]]),
                l === b && h && (l = g.data(h, a), l = c(h, a, l)),
    ...
    g.extend({
        queue: function(a, b, c) {
            ...
            d = g._data(a, b),
            c && (!d || g.isArray(c) ? d = g._data(a, b, g.makeArray(c)) : d.push(c)),
            d || []
        },
        dequeue: function(a, b) {
            ...
            e && ("fx" === b && c.unshift("inprogress"), delete f.stop, e.call(a, r, f)); ! d && f && f.empty.fire()
        },
    ...
    g.fn.extend({
        queue: function(a, c) {
            ...
            arguments.length < d ? g.queue(this[0], a) : c === b ? this: this.each(function() {
        ...
        delay: function(a, b) {
            return a = g.fx ? g.fx.speeds[a] || a: a,
            b = b || "fx",
            this.queue(b,
            function(b, c) {
    ...
    g.fn.extend({
        ...
        removeClass: function(a) {
            ...
            if (a && "string" == typeof a || a === b) {
                c = (a || "").split(aa);
                r = 0;
                for (j = this.length; r < j; r++) if (e = this[r], 1 === e.nodeType && e.className) {
                    d = (" " + e.className + " ").replace(Ib, " ");
                    f = 0;
                    for (k = c.length; f < k; f++) for (; 0 <= d.indexOf(" " + c[f] + " ");) d = d.replace(" " + c[f] + " ", " ");
        ...
        toggleClass: function(a, b) {
            ...
            return g.isFunction(a) ? this.each(function(c) {
                ...
                r = g(this), k = b, j = a.split(aa); e = j[f++];) k = d ? k: !r.hasClass(e),
                r[k ? "addClass": "removeClass"](e);
                else if ("undefined" === c || "boolean" === c) this.className && g._data(this, "__className__", this.className),
                this.className = this.className || !1 === a ? "": g._data(this, "__className__") || ""
            })
        },
        hasClass: function(a) {
            a = " " + a + " ";
            for (var b = 0,
            c = this.length; b < c; b++) if (1 === this[b].nodeType && 0 <= (" " + this[b].className + " ").replace(Ib, " ").indexOf(a)) return ! 0;
            return ! 1
        },
        val: function(a) {
            var c, d, e, f = this[0];
            if (arguments.length) return e = g.isFunction(a),
            this.each(function(d) {
                var f, I = g(this);
                if (1 === this.nodeType && (e ? f = a.call(this, d, I.val()) : f = a, null == f ? f = "": "number" == typeof f ? f += "": g.isArray(f) && (f = g.map(f,
                function(a) {
                    return null == a ? "": a + ""
                })), c = g.valHooks[this.type] || g.valHooks[this.nodeName.toLowerCase()], !c || !("set" in c) || c.set(this, f, "value") === b)) this.value = f
            });
            if (f) return c = g.valHooks[f.type] || g.valHooks[f.nodeName.toLowerCase()],
            c && "get" in c && (d = c.get(f, "value")) !== b ? d: (d = f.value, "string" == typeof d ? d.replace(Lc, "") : null == d ? "": d)
        }
    });
    g.extend({
        valHooks: {
            ...
            select: {
                get: function(a) {
                    ...
                    if (0 > d) return null;
                    a = r ? d: 0;
                    for (c = r ? d + 1 : f.length; a < c; a++) if (b = f[a], b.selected && (g.support.optDisabled ? !b.disabled: null === b.getAttribute("disabled")) && (!b.parentNode.disabled || !g.nodeName(b.parentNode, "optgroup"))) {
                        b = g(b).val();
                        if (r) return b;
                        e.push(b)
                    }
        ...
        attr: function(a, c, d, e) {
            ...
            if (a && !(3 === r || 8 === r || 2 === r)) {
                ...
                if ("undefined" == typeof a.getAttribute) return g.prop(a, c, d); (e = 1 !== r || !g.isXMLDoc(a)) && (c = c.toLowerCase(), k = g.attrHooks[c] || (Jb.test(c) ? Gb: W));
                if (d !== b) {
                    if (null === d) {
                        g.removeAttr(a, c);
                        return
        ...
        removeAttr: function(a, b) {
            var c, d, e, f, k = 0;
            if (b && 1 === a.nodeType) for (d = b.split(aa); k < d.length; k++)(e = d[k]) && (c = g.propFix[e] || e, f = Jb.test(e), f || g.attr(a, e, ""), a.removeAttribute(Kb ? e: c), f && c in a && (a[c] = !1))
        },
        attrHooks: {
            type: {
                set: function(a, b) {
        ...
        prop: function(a, c, d) {
            var e, f, k, r = a.nodeType;
            if (a && !(3 === r || 8 === r || 2 === r)) return k = 1 !== r || !g.isXMLDoc(a),
            k && (c = g.propFix[c] || c, f = g.propHooks[c]),
    ...
    Gb = {
        ...
        set: function(a, b, c) {
            var d;
            return ! 1 === b ? g.removeAttr(a, c) : (d = g.propFix[c] || c, d in a && (a[d] = !0), a.setAttribute(c, c.toLowerCase())),
            c
        }
    };
    Kb || (Hb = {
    ...
    W = g.valHooks.button = {
        get: function(a, c) {
            ...
            d && (Hb[c] ? "" !== d.value: d.specified) ? d.value: b
        },
        set: function(a, b, c) {
    ...
    g.support.hrefNormalized || g.each(["href", "src", "width", "height"],
    function(a, c) {
    ...
    g.support.checkOn || g.each(["radio", "checkbox"],
    function() {
        g.valHooks[this] = {
            get: function(a) {
    ...
    g.event = {
        add: function(a, c, d, e, f) {
            ...
            if (! (3 === a.nodeType || 8 === a.nodeType || !c || !d || !(k = g._data(a)))) {
                ...
                d.guid || (d.guid = g.guid++); (j = k.events) || (k.events = j = {}); (r = k.handle) || (k.handle = r = function(a) {
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (y && (s = y.events)) {
                b = g.trim(Nb(b || "")).split(" ");
                for (f = 0; f < b.length; f++) if (k = Lb.exec(b[f]) || [], j = h = k[1], k = k[2], j) {
                    m = g.event.special[j] || {};
                    j = (d ? m.delegateType: m.bindType) || j;
                    q = s[j] || [];
                    p = q.length;
                    k = k ? RegExp("(^|\\.)" + k.split(".").sort().join("\\.(?:.*\\.|)") + "(\\.|$)") : null;
                    for (l = 0; l < q.length; l++) u = q[l],
                    (e || h === u.origType) && (!c || c.guid === u.guid) && (!k || k.test(u.namespace)) && (!d || d === u.selector || "**" === d && u.selector) && (q.splice(l--, 1), u.selector && q.delegateCount--, m.remove && m.remove.call(a, u));
                    0 === q.length && p !== q.length && ((!m.teardown || !1 === m.teardown.call(a, k, y.handle)) && g.removeEvent(a, j, y.handle), delete s[j])
                } else for (j in s) g.event.remove(a, j + b[f], c, d, !0);
        ...
        trigger: function(c, d, e, f) {
            if (!e || 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                h = [];
                if (!Mb.test(m + g.event.triggered) && (0 <= m.indexOf("!") && (m = m.slice(0, -1), k = !0), 0 <= m.indexOf(".") && (h = m.split("."), m = h.shift(), h.sort()), e && !g.event.customEvent[m] || g.event.global[m])) if (c = "object" == typeof c ? c[g.expando] ? c: new g.Event(m, c) : new g.Event(m), c.type = m, c.isTrigger = !0, c.exclusive = k, c.namespace = h.join("."), c.namespace_re = c.namespace ? RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, h = 0 > m.indexOf(":") ? "on" + m: "", e) {
                    if (c.result = b, c.target || (c.target = e), d = null != d ? g.makeArray(d) : [], d.unshift(c), p = g.event.special[m] || {},
                    !(p.trigger && !1 === p.trigger.apply(e, d))) {
                        s = [[e, p.bindType || m]];
                        ...
                        for (j = 0; j < s.length && !c.isPropagationStopped(); j++) k = s[j][0],
                        c.type = s[j][1],
                        (l = (g._data(k, "events") || {})[c.type] && g._data(k, "handle")) && l.apply(k, d),
                        (l = h && k[h]) && g.acceptData(k) && l.apply && !1 === l.apply(k, d) && c.preventDefault();
                        return c.type = m,
                        !f && !c.isDefaultPrevented() && (!p._default || !1 === p._default.apply(e.ownerDocument, d)) && ("click" !== m || !g.nodeName(e, "a")) && g.acceptData(e) && h && e[m] && ("focus" !== m && "blur" !== m || 0 !== c.target.offsetWidth) && !g.isWindow(e) && (r = e[h], r && (e[h] = null), g.event.triggered = m, e[m](), g.event.triggered = b, r && (e[h] = r)),
                        c.result
                    }
                } else for (j in e = g.cache, e) e[j].events && e[j].events[m] && g.event.trigger(c, d, e[j].handle.elem, !0)
            }
        },
        dispatch: function(c) {
            ...
            if (! (m.preDispatch && !1 === m.preDispatch.call(this, c))) {
                if (p && (!c.button || "click" !== c.type)) for (e = c.target; e != this; e = e.parentNode || this) if (!0 !== e.disabled || "click" !== c.type) {
                    k = {};
                    j = [];
                    for (d = 0; d < p; d++) f = h[d],
                    r = f.selector,
                    k[r] === b && (k[r] = f.needsContext ? 0 <= g(r, this).index(e) : g.find(r, this, null, [e]).length),
                    k[r] && j.push(f);
                    j.length && q.push({
                        elem: e,
                        matches: j
                ...
                for (d = 0; d < q.length && !c.isPropagationStopped(); d++) {
                    ...
                    for (e = 0; e < k.matches.length && !c.isImmediatePropagationStopped(); e++) if (f = k.matches[e], s || !c.namespace && !f.namespace || c.namespace_re && c.namespace_re.test(f.namespace)) c.data = f.data,
                    c.handleObj = f,
                    f = ((g.event.special[f.origType] || {}).handle || f.handler).apply(k.elem, l),
                    f !== b && (c.result = f, !1 === f && (c.preventDefault(), c.stopPropagation()))
                }
        ...
        mouseHooks: {
            ...
            filter: function(a, c) {
                ...
                k = c.fromElement;
                return null == a.pageX && null != c.clientX && (d = a.target.ownerDocument || t, e = d.documentElement, g = d.body, a.pageX = c.clientX + (e && e.scrollLeft || g && g.scrollLeft || 0) - (e && e.clientLeft || g && g.clientLeft || 0), a.pageY = c.clientY + (e && e.scrollTop || g && g.scrollTop || 0) - (e && e.clientTop || g && g.clientTop || 0)),
                !a.relatedTarget && k && (a.relatedTarget = k === a.target ? c.toElement: k),
        ...
        fix: function(a) {
            ...
            a = g.Event(d);
            for (b = f.length; b;) c = f[--b],
            a[c] = d[c];
            return a.target || (a.target = d.srcElement || t),
    ...
    g.removeEvent = t.removeEventListener ?
    function(a, b, c) {
    ...
    g.Event = function(a, b) {
        if (this instanceof g.Event) a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || !1 === a.returnValue || a.getPreventDefault && a.getPreventDefault() ? f: e) : this.type = a,
        b && g.extend(this, b),
    ...
    function(a, b) {
        g.event.special[a] = {
            ...
            handle: function(a) {
                ...
                x = a.handleObj;
                if (!d || d !== this && !g.contains(this, d)) a.type = x.origType,
    ...
    g.support.submitBubbles || (g.event.special.submit = {
        setup: function() {
            ...
            g.event.add(this, "click._submit keypress._submit",
            function(a) {
                a = a.target; (a = g.nodeName(a, "input") || g.nodeName(a, "button") ? a.form: b) && !g._data(a, "_submit_attached") && (g.event.add(a, "submit._submit",
                function(a) {
                    a._submit_bubble = !0
    ...
    g.support.changeBubbles || (g.event.special.change = {
        setup: function() {
            if ($a.test(this.nodeName)) {
                ...
                g.event.add(this, "click._change",
                function(a) {
            ...
            g.event.add(this, "beforeactivate._change",
            function(a) {
                a = a.target;
                $a.test(a.nodeName) && !g._data(a, "_change_attached") && (g.event.add(a, "change._change",
                function(a) {
    ...
    g.fn.extend({
        on: function(a, c, d, f, k) {
            ...
            f.guid = j.guid || (j.guid = g.guid++)),
            this.each(function() {
                g.event.add(this, a, f, d, c)
            })
        },
        ...
        off: function(a, c, d) {
            ...
            g(a.delegateTarget).off(f.namespace ? f.origType + "." + f.namespace: f.origType, f.selector, f.handler),
            this;
            if ("object" == typeof a) {
                for (k in a) this.off(k, c, a[k]);
                return this
            }
            if (!1 === c || "function" == typeof c) d = c,
            c = b;
            return ! 1 === d && (d = e),
            this.each(function() {
        ...
        live: function(a, b, c) {
            return g(this.context).on(a, this.selector, b, c),
            this
        },
        die: function(a, b) {
            return g(this.context).off(a, this.selector || "**", b),
            this
        },
        ...
        toggle: function(a) {
            ...
            e = function(c) {
                ...
                return g._data(this, "lastToggle" + a.guid, e + 1),
                c.preventDefault(),
    ...
    w = function(a, b, c, d) {
        ...
        if (1 !== j && 9 !== j) return [];
        f = Ga(b);
        if (!f && !d && (e = Tc.exec(a))) if (k = e[1]) if (9 === j) {
            g = b.getElementById(k);
            if (!g || !g.parentNode) return c;
            if (g.id === k) return c.push(g),
            c
        } else {
            if (b.ownerDocument && (g = b.ownerDocument.getElementById(k)) && Ob(b, g) && g.id === k) return c.push(g),
            c
        } else {
            if (e[2]) return ka.apply(c, la.call(b.getElementsByTagName(a), 0)),
            c;
            if ((k = e[3]) && Pb && b.getElementsByClassName) return ka.apply(c, la.call(b.getElementsByClassName(k), 0)),
            c
        }
    ...
    Ka = function(a, b) {
        ...
        k = [];
        for (j = F.preFilter; f;) {
            if (!c || (d = Uc.exec(f))) d && (f = f.slice(d[0].length)),
            k.push(e = []);
            c = !1;
            if (d = Vc.exec(f)) e.push(c = new Sb(d.shift())),
            f = f.slice(c.length),
            c.type = d[0].replace(Ha, " ");
            for (g in F.filter)(d = Ja[g].exec(f)) && (!j[g] || (d = j[g](d, S, !0))) && (e.push(c = new Sb(d.shift())), f = f.slice(c.length), c.type = g, c.matches = d);
            if (!c) break
        }
    ...
    cb = function(a, b, c) {
        ...
        return b.first ?
        function(b, c, g) {
            for (; b = b[d];) if (e || 1 === b.nodeType) return a(b, c, g)
        }: function(b, c, f) {
            if (f) for (; b = b[d];) {
                if ((e || 1 === b.nodeType) && a(b, c, f)) return b
            } else for (var C, k = sa + " " + g + " ",
            j = k + bb; b = b[d];) if (e || 1 === b.nodeType) {
                if ((C = b[A]) === j) return b.sizset;
                if ("string" == typeof C && 0 === C.indexOf(k)) {
                    if (b.sizset) return b
                } else {
                    b[A] = j;
                    if (a(b, c, f)) return b.sizset = !0,
                    b;
                    b.sizset = !1
                }
            }
    ...
    La = function(a, b, c, d, e) {
        for (var g, f = [], k = 0, j = a.length, h = null != b; k < j; k++) if (g = a[k]) if (!c || c(g, d, e)) f.push(g),
        h && b.push(k);
        return f
    },
        ...
        T(function(g, f, k, j) {
            if (!g || !e) {
                ...
                if (d) {
                    p = La(q, s);
                    d(p, [], k, j);
                    for (k = p.length; k--;) if (h = p[k]) q[s[k]] = !(G[s[k]] = h)
                }
                if (g) for (k = a && q.length; k--;) {
                    if (h = q[k]) g[l[k]] = !(f[l[k]] = h)
                } else q = La(q === f ? q.splice(m, q.length) : q),
                e ? e(null, f, q, j) : ka.apply(f, q)
            }
        })
    },
    fb = function(a) {
    ...
    ab = function(a, b, c, d, e) {
        ...
        if (!d && 1 === h.length) {
            ...
            for (g = Ja.POS.test(a) ? -1 : f.length - 1; 0 <= g; g--) {
                ...
                if (j = F.find[j]) if (d = j(k.matches[0].replace(ea, ""), gb.test(f[0].type) && b.parentNode || b, e)) {
                    f.splice(g, 1);
                    a = d.length && f.join("");
                    if (!a) return ka.apply(c, la.call(d, 0)),
                    c;
                    break
                }
            }
        }
        return hb(a, h)(d, b, e, c, gb.test(a)),
        c
    },
    Ub = function() {},
    bb,
    ...
    Pb = X(function(a) {
        ...
        !a.getElementsByClassName || !a.getElementsByClassName("e").length ? !1 : (a.lastChild.className = "e", 2 === a.getElementsByClassName("e").length)
    }),
    dd = X(function(a) {
        a.id = A + 0;
    ...
    Na = w.getText = function(a) {
        ...
        if (b = a.nodeType) if (1 === b || 9 === b || 11 === b) {
            ...
            for (a = a.firstChild; a; a = a.nextSibling) c += Na(a)
        } else {
            if (3 === b || 4 === b) return a.nodeValue
        } else for (; b = a[d]; d++) c += Na(b);
        return c
    };
    Ga = w.isXML = function(a) {
        return (a = a && (a.ownerDocument || a).documentElement) ? "HTML" !== a.nodeName: !1
    };
    Ob = w.contains = R.contains ?
    function(a, b) {
    ...
    w.attr = function(a, b) {
        ...
        (c = F.attrHandle[b]) ? c(a) : d || cd ? a.getAttribute(b) : (c = a.getAttributeNode(b), c ? "boolean" == typeof a[b] ? a[b] ? b: null: c.specified ? c.value: null: null)
    };
    F = w.selectors = {
        cacheLength: 50,
        createPseudo: T,
        ...
        preFilter: {
            ATTR: function(a) {
                return a[1] = a[1].replace(ea, ""),
                a[3] = (a[4] || a[5] || "").replace(ea, ""),
                "~=" === a[2] && (a[3] = " " + a[3] + " "),
                a.slice(0, 4)
            },
            CHILD: function(a) {
                return a[1] = a[1].toLowerCase(),
                "nth" === a[1] ? (a[2] || w.error(a[0]), a[3] = +(a[3] ? a[4] + (a[5] || 1) : 2 * ("even" === a[2] || "odd" === a[2])), a[4] = +(a[6] + a[7] || "odd" === a[2])) : a[2] && w.error(a[0]),
                a
            },
            PSEUDO: function(a) {
                var b, c;
                ...
                if (a[3]) a[2] = a[3];
                else if (b = a[4]) Yc.test(b) && (c = Ka(b, !0)) && (c = b.indexOf(")", b.length - c) - b.length) && (b = b.slice(0, c), a[0] = a[0].slice(0, c)),
                a[2] = b;
                return a.slice(0, 3)
            }
        },
        filter: {
            ...
            ATTR: function(a, b, c) {
                return function(d) {
                    d = w.attr(d, a);
                    return null == d ? "!=" === b: b ? (d += "", "=" === b ? d === c: "!=" === b ? d !== c: "^=" === b ? c && 0 === d.indexOf(c) : "*=" === b ? c && -1 < d.indexOf(c) : "$=" === b ? c && d.substr(d.length - c.length) === c: "~=" === b ? -1 < (" " + d + " ").indexOf(c) : "|=" === b ? d === c || d.substr(0, c.length + 1) === c + "-": !1) : !0
                }
            },
            ...
            PSEUDO: function(a, b) {
                ...
                return d[A] ? d(b) : 1 < d.length ? (c = [a, a, "", b], F.setFilters.hasOwnProperty(a.toLowerCase()) ? T(function(a, c) {
                    for (var e, g = d(a, b), f = g.length; f--;) e = Tb.call(a, g[f]),
                    a[e] = !(c[e] = g[f])
                }) : function(a) {
                    return d(a, 0, c)
                }) : d
        ...
        pseudos: {
            not: T(function(a) {
                ...
                return d[A] ? T(function(a, b, c, e) {
                    e = d(a, null, e, []);
                    for (var g = a.length; g--;) if (c = e[g]) a[g] = !(b[g] = c)
                }) : function(a, e, g) {
                    return b[0] = a,
                    d(b, null, g, c),
                    !c.pop()
    ...
    function(a, b) {
        ...
        c = e.length;
        d = g.length;
        for (f = 0; f < c && f < d; f++) if (e[f] !== g[f]) return Ia(e[f], g[f]);
    ...
    w.uniqueSort = function(a) {
        ...
        ta = Vb;
        a.sort(jb);
        if (ta) for (; b = a[c]; c++) b === a[c - 1] && a.splice(c--, 1);
        return a
    };
    w.error = function(a) {
    ...
    hb = w.compile = function(a, b) {
        ...
        if (!g) {
            b || (b = Ka(a));
            for (c = b.length; c--;) g = fb(b[c]),
            g[A] ? d.push(g) : e.push(g);
            var f = 0 < d.length,
            k = 0 < e.length,
            j = function(a, b, c, g, x) {
                ...
                if (f && I !== l) {
                    ...
                    if (a) {
                        if (0 < l) for (; I--;) ! s[I] && !p[I] && (p[I] = Xc.call(g));
                        p = La(p)
                    }
                    ka.apply(g, p);
    ...
    if (S.querySelectorAll) {
        ...
        U = [":focus"],
        Oa = [":active", ":focus"],
        Pa = R.matchesSelector || R.mozMatchesSelector || R.webkitMatchesSelector || R.oMatchesSelector || R.msMatchesSelector;
        X(function(a) {
        ...
        ab = function(a, b, c, d, e) {
            if (!d && !e && (!U || !U.test(a))) {
                ...
                if (1 === b.nodeType && "object" !== b.nodeName.toLowerCase()) {
                    g = Ka(a); (k = b.getAttribute("id")) ? j = k.replace(fd, "\\$&") : b.setAttribute("id", j);
                    j = "[id='" + j + "'] ";
                ...
                if (g) try {
                    return ka.apply(c, la.call(f.querySelectorAll(g), 0)),
                    c
                } catch(h) {} finally {
    ...
    g.fn.extend({
        find: function(a) {
            ...
            if ("string" != typeof a) return g(a).filter(function() {
                b = 0;
                for (c = j.length; b < c; b++) if (g.contains(j[b], this)) return ! 0
            });
            k = this.pushStack("", "find", a);
            b = 0;
            for (c = this.length; b < c; b++) if (d = k.length, g.find(a, this[b], k), 0 < b) for (e = d; e < k.length; e++) for (f = 0; f < d; f++) if (k[f] === k[e]) {
                k.splice(e--, 1);
                break
            }
            return k
        ...
        has: function(a) {
            ...
            return this.filter(function() {
                for (b = 0; b < d; b++) if (g.contains(this, c[b])) return ! 0
            })
        },
        not: function(a) {
        ...
        closest: function(a, b) {
            for (var c, d = 0,
            e = this.length,
            f = [], k = $b.test(a) || "string" != typeof a ? g(a, b || this.context) : 0; d < e; d++) for (c = this[d]; c && c.ownerDocument && c !== b && 11 !== c.nodeType;) {
            ...
            return f = 1 < f.length ? g.unique(f) : f,
    ...
    function(a, b) {
        g.fn[a] = function(c, d) {
            ...
            return hd.test(a) || (d = c),
            d && "string" == typeof d && (e = g.filter(d, e)),
            e = 1 < this.length && !kd[a] ? g.unique(e) : e,
            1 < this.length && jd.test(a) && (e = e.reverse()),
    ...
    g.extend({
        filter: function(a, b, c) {
            return c && (a = ":not(" + a + ")"),
            1 === b.length ? g.find.matchesSelector(b[0], a) ? [b[0]] : [] : g.find.matches(a, b)
        },
        dir: function(a, c, d) {
            var e = [];
            for (a = a[c]; a && 9 !== a.nodeType && (d === b || 1 !== a.nodeType || !g(a).is(d));) 1 === a.nodeType && e.push(a),
            a = a[c];
            return e
        },
    ...
    g.fn.extend({
        ...
        before: function() {
            ...
            if (arguments.length) {
                ...
                return this.pushStack(g.merge(a, this), "before", this.selector)
            }
        },
        after: function() {
            if (!h(this[0])) return this.domManip(arguments, !1,
        ...
        remove: function(a, b) {
            for (var c, d = 0; null != (c = this[d]); d++) if (!a || g.filter(a, [c]).length) ! b && 1 === c.nodeType && (g.cleanData(c.getElementsByTagName("*")), g.cleanData([c])),
            c.parentNode && c.parentNode.removeChild(c);
            return this
        },
        empty: function() {
            for (var a, b = 0; null != (a = this[b]); b++) for (1 === a.nodeType && g.cleanData(a.getElementsByTagName("*")); a.firstChild;) a.removeChild(a.firstChild);
            return this
        },
        clone: function(a, b) {
            return a = null == a ? !1 : a,
        ...
        html: function(a) {
            ...
            function(a) {
                ...
                if ("string" == typeof a && !od.test(a) && (g.support.htmlSerialize || !nb.test(a)) && (g.support.leadingWhitespace || !mb.test(a)) && !Q[(bc.exec(a) || ["", ""])[1].toLowerCase()]) {
                    a = a.replace(ac, "<$1></$2>");
                    try {
                        for (; d < e; d++) c = this[d] || {},
                        1 === c.nodeType && (g.cleanData(c.getElementsByTagName("*")), c.innerHTML = a);
                        c = 0
                    } catch(f) {}
                }
    ...
    g.buildFragment = function(a, c, d) {
        ...
        c = !c.nodeType && c[0] || c,
        c = c.ownerDocument || c,
        1 === a.length && "string" == typeof j && 512 > j.length && c === t && "<" === j.charAt(0) && !pd.test(j) && (g.support.checkClone || !cc.test(j)) && (g.support.html5Clone || !nb.test(j)) && (f = !0, e = g.fragments[j], k = e !== b),
        e || (e = c.createDocumentFragment(), g.clean(a, c, e, d), f && (g.fragments[j] = k && e)),
        {
            fragment: e,
            cacheable: f
        }
    ...
    function(a, b) {
        g.fn[a] = function(c) {
            ...
            if ((null == d || d && 11 === d.nodeType && 1 === d.childNodes.length) && 1 === k) return c[b](this[0]),
            this;
            for (; e < k; e++) d = (0 < e ? this.clone(!0) : this).get(),
            g(c[e])[b](d),
            f = f.concat(d);
    ...
    g.extend({
        clone: function(a, b, c) {
            var d, e, f, j;
            g.support.html5Clone || g.isXMLDoc(a) || !nb.test("<" + a.nodeName + ">") ? j = a.cloneNode(!0) : (ob.innerHTML = a.outerHTML, ob.removeChild(j = ob.firstChild));
        ...
        clean: function(a, b, c, d) {
            ...
            for (e = 0; null != (k = a[e]); e++) if ("number" == typeof k && (k += ""), k) {
                if ("string" == typeof k) if (nd.test(k)) {
                    m = m || q(b);
                    ...
                    } ! g.support.leadingWhitespace && mb.test(k) && p.insertBefore(b.createTextNode(mb.exec(k)[0]), p.firstChild);
                    k = p.childNodes;
            ...
            p && (k = p = m = null);
            if (!g.support.appendChecked) for (e = 0; null != (k = u[e]); e++) g.nodeName(k, "input") ? s(k) : "undefined" != typeof k.getElementsByTagName && g.grep(k.getElementsByTagName("input"), s);
            if (c) {
                a = function(a) {
                    if (!a.type || qd.test(a.type)) return d ? d.push(a.parentNode ? a.parentNode.removeChild(a) : a) : c.appendChild(a)
                };
                for (e = 0; null != (k = u[e]); e++) if (!g.nodeName(k, "script") || !a(k)) c.appendChild(k),
        ...
        cleanData: function(a, b) {
            ...
            j = g.expando,
            h = g.cache,
            p = g.support.deleteExpando,
            l = g.event.special; null != (e = a[k]); k++) if (b || g.acceptData(e)) if (c = (d = e[j]) && h[d]) {
                if (c.events) for (f in c.events) l[f] ? g.event.remove(e, f) : g.removeEvent(e, f, c.handle);
    ...
    g.sub = function() {
        ...
        a.fn.init = function(c, d) {
            return d && d instanceof g && !(d instanceof a) && (d = a(d)),
            g.fn.init.call(this, c, d, b)
        };
    ...
    g.fn.extend({
        ...
        toggle: function(a, b) {
            ...
            return g.isFunction(a) && g.isFunction(b) ? xd.apply(this, arguments) : this.each(function() { (c ? a: y(this)) ? g(this).show() : g(this).hide()
            })
        }
    });
    g.extend({
        ...
        style: function(a, c, d, e) {
            if (a && !(3 === a.nodeType || 8 === a.nodeType || !a.style)) {
                ...
                if (! (null == d || "number" === k && isNaN(d))) if ("number" === k && !g.cssNumber[h] && (d += "px"), !j || !("set" in j) || (d = j.set(a, d, e)) !== b) try {
                    p[c] = d
                } catch(l) {}
            }
        },
        css: function(a, c, d, e) {
            var f, k, j, h = g.camelCase(c);
            return c = g.cssProps[h] || (g.cssProps[h] = u(a.style, h)),
            j = g.cssHooks[c] || g.cssHooks[h],
            j && "get" in j && (f = j.get(a, !0, e)),
            f === b && (f = L(a, c)),
            "normal" === f && c in fc && (f = fc[c]),
            d || e !== b ? (k = parseFloat(f), d || g.isNumeric(k) ? k || 0 : f) : f
        },
        swap: function(a, b, c) {
            var d, e = {};
    ...
    a.getComputedStyle ? L = function(b, c) {
        ...
        h = b.style;
        return j && (d = j[c], "" === d && !g.contains(b.ownerDocument, b) && (d = g.style(b, c)), ua.test(d) && ec.test(c) && (e = h.width, f = h.minWidth, k = h.maxWidth, h.minWidth = h.maxWidth = h.width = d, d = j.width, h.width = e, h.minWidth = f, h.maxWidth = k)),
        d
    }: t.documentElement.currentStyle && (L = function(a, b) {
        var c, d, e = a.currentStyle && a.currentStyle[b],
        f = a.style;
        return null == e && f && f[b] && (e = f[b]),
        ua.test(e) && !td.test(b) && (c = f.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), f.left = "fontSize" === b ? "1em": e, e = f.pixelLeft + "px", f.left = c, d && (a.runtimeStyle.left = d)),
        "" === e ? "auto": e
    });
    g.each(["height", "width"],
    function(a, b) {
        g.cssHooks[b] = {
            get: function(a, c, d) {
                if (c) return 0 === a.offsetWidth && ud.test(L(a, "display")) ? g.swap(a, wd,
                function() {
                    return z(a, b, d)
                }) : z(a, b, d)
            },
    ...
    g(function() {
        ...
        }); ! g.support.pixelPosition && g.fn.position && g.each(["top", "left"],
        function(a, b) {
            g.cssHooks[b] = {
                get: function(a, c) {
                    if (c) {
    ...
    g.expr && g.expr.filters && (g.expr.filters.hidden = function(a) {
        return 0 === a.offsetWidth && 0 === a.offsetHeight || !g.support.reliableHiddenOffsets && "none" === (a.style && a.style.display || L(a, "display"))
    },
    ...
    g.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var c = g(this).val();
                return null == c ? null: g.isArray(c) ? g.map(c,
                function(a) {
                    return {
                        name: b.name,
                        value: a.replace(gc, "\r\n")
    ...
    g.fn.load = function(a, c, d) {
        ...
        var e, f, k, j = this,
        h = a.indexOf(" ");
        return 0 <= h && (e = a.slice(h, a.length), a = a.slice(0, h)),
        g.isFunction(c) ? (d = c, c = b) : c && "object" == typeof c && (f = "POST"),
        g.ajax({
            url: a,
            type: f,
            dataType: "html",
    ...
    g.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),
    function(a, b) {
        g.fn[b] = function(a) {
            return this.on(b, a)
        }
    ...
    function(a, c) {
        g[c] = function(a, d, e, f) {
            return g.isFunction(d) && (f = f || e, e = d, d = b),
            g.ajax({
                type: c,
                url: a,
                data: d,
    ...
    g.extend({
        ...
        ajaxSetup: function(a, b) {
            return b ? oa(a, g.ajaxSettings) : (b = a, a = g.ajaxSettings),
            oa(a, b),
            a
        },
        ajaxSettings: {
        ...
        ajax: function(a, c) {
            function d(a, c, k, p) {
                ...
                if (2 !== z) {
                    ...
                    if (k) {
                        ...
                        if (P) for (M in F) if (F[M] && F[M].test(P)) {
                            H.unshift(M);
                            break
                        }
                        if (H[0] in k) w = H[0];
                    ...
                    if (200 <= a && 300 > a || 304 === a) if (m.ifModified && (G = B.getResponseHeader("Last-Modified"), G && (g.lastModified[e] = G), G = B.getResponseHeader("Etag"), G && (g.etag[e] = G)), 304 === a) v = "notmodified",
                    s = !0;
                    else {
                        var A;
                        a: {
                            s = m;
                            x = I;
                            var J, v = s.dataTypes.slice();
                            k = v[0];
                            P = {};
                            M = 0;
                            s.dataFilter && (x = s.dataFilter(x, s.dataType));
                            if (v[1]) for (A in s.converters) P[A.toLowerCase()] = s.converters[A];
                            for (; C = v[++M];) if ("*" !== C) {
                                if ("*" !== k && k !== C) {
                                    A = P[k + " " + C] || P["* " + C];
                                    if (!A) for (J in P) if (G = J.split(" "), G[1] === C && (A = P[k + " " + G[0]] || P["* " + G[0]])) { ! 0 === A ? A = P[J] : !0 !== P[J] && (C = G[0], v.splice(M--, 0, C));
                                        break
                                    }
                                    if (!0 !== A) if (A && s["throws"]) x = A(x);
                                    else try {
                                        x = A(x)
                                    } catch(L) {
                                        A = {
            ...
            c = c || {};
            var e, f, k, j, h, p, l, s, m = g.ajaxSetup({},
            c),
            q = m.context || m,
            ...
            B = {
                ...
                getResponseHeader: function(a) {
                    var c;
                    if (2 === z) {
                        if (!k) for (k = {}; c = Cd.exec(f);) k[c[1].toLowerCase()] = c[2];
                        c = k[a.toLowerCase()]
                    }
                    return c === b ? null: c
                },
                overrideMimeType: function(a) {
                    return z || (m.mimeType = a),
                    this
                },
                abort: function(a) {
                    return a = a || E,
    ...
    function(c, d, e) {
        ...
        if ("jsonp" === c.dataTypes[0] || m || s) return f = c.jsonpCallback = g.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback,
        k = a[f],
        m ? c.url = p.replace(Ra, "$1" + f) : s ? c.data = h.replace(Ra, "$1" + f) : l && (c.url += (Hd.test(p) ? "&": "?") + c.jsonp + "=" + f),
        c.converters["script json"] = function() {
            return j || g.error(f + " was not called"),
            j[0]
        },
        c.dataTypes[0] = "json",
        a[f] = function() {
    ...
    g.ajaxSetup({
        ...
        converters: {
            "text script": function(a) {
                return g.globalEval(a),
                a
            }
        }
    });
    g.ajaxPrefilter("script",
    function(a) {
        a.cache === b && (a.cache = !1);
    ...
    var na, qb = a.ActiveXObject ?
    function() {
        for (var a in na) na[a](0, 1)
    }: !1,
    Jd = 0;
    g.ajaxSettings.xhr = a.ActiveXObject ?
    function() {
        var b;
            ...
            return {
                send: function(e, f) {
                    ...
                    d = function(a, e) {
                        var j, p, l, m, s;
                        try {
                            if (d && (e || 4 === h.readyState)) if (d = b, k && (h.onreadystatechange = g.noop, qb && delete na[k]), e) 4 !== h.readyState && h.abort();
                            else {
                                j = h.status;
                                l = h.getAllResponseHeaders();
                                m = {}; (s = h.responseXML) && s.documentElement && (m.xml = s);
                                try {
                    ...
                    c.async ? 4 === h.readyState ? setTimeout(d, 0) : (k = ++Jd, qb && (na || (na = {},
                    g(a).unload(qb)), na[k] = d), h.onreadystatechange = d) : d()
                },
                abort: function() {
                    d && d(0, 1)
                }
    ...
    xa = [function(a, b, c) {
        ...
        s = [],
        q = a.nodeType && y(a);
        c.queue || (j = g._queueHooks(a, "fx"), null == j.unqueued && (j.unqueued = 0, h = j.empty.fire, j.empty.fire = function() {
            j.unqueued || h()
        ...
        for (d in b) e = b[d],
        Kd.exec(e) && (delete b[d], e !== (q ? "hide": "show") && s.push(d));
        if (e = s.length) {
            ...
            for (d = 0; d < e; d++) b = s[d],
            k = p.createTween(b, q ? f[b] : 0),
            m[b] = f[b] || g.style(a, b),
            b in f || (f[b] = k.start, q && (k.end = k.start, k.start = "width" === b || "height" === b ? 1 : 0))
        }
    }],
    pa = {
        "*": [function(a, b) {
            ...
            if (f) {
                ...
                if ("px" !== d && j) {
                    ...
                    do h = h || ".5",
                    j /= h,
                    g.style(e.elem, a, j + d);
                    while (h !== (h = e.cur() / k) && 1 !== h && --p)
                }
                e.unit = d;
                e.start = j;
    ...
    N.prototype = {
        ...
        run: function(a) {
            ...
            return this.options.duration ? this.pos = b = g.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : this.pos = b = a,
    ...
    g.fn.extend({
        ...
        stop: function(a, c, d) {
            ...
            this.each(function() {
                ...
                else for (c in k) k[c] && k[c].stop && Md.test(c) && e(k[c]);
                for (c = f.length; c--;) f[c].elem === this && (null == a || f[c].queue === a) && (f[c].anim.stop(d), b = !1, f.splice(c, 1)); (b || !d) && g.dequeue(this, a)
            })
        }
    });
    g.each({
    ...
    g.speed = function(a, b, c) {
        var d = a && "object" == typeof a ? g.extend({},
        a) : {
    ...
    g.offset = {
        ...
        setOffset: function(a, b, c) {
            ...
            p = {},
            l,
            m; ("absolute" === d || "fixed" === d) && -1 < g.inArray("auto", [k, j]) ? (p = e.position(), l = p.top, m = p.left) : (l = parseFloat(k) || 0, m = parseFloat(j) || 0);
    ...
    g.fn.extend({
        position: function() {
            if (this[0]) {
                ...
                return c.top -= parseFloat(g.css(a, "marginTop")) || 0,
                c.left -= parseFloat(g.css(a, "marginLeft")) || 0,
                d.top += parseFloat(g.css(b[0], "borderTopWidth")) || 0,
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var a = this.offsetParent || t.body; a && !nc.test(a.nodeName) && "static" === g.css(a, "position");) a = a.offsetParent;
                return a || t.body
            })
        }
    });
...
jukebox.Manager = function(a) {
    ...
    if ("[object Object]" === Object.prototype.toString.call(a)) for (var c in a) this.settings[c] = a[c];
...
jukebox.Manager.prototype = {
    ...
    __detectFeatures: function() {
        ...
        if (a && a.canPlayType && !1 === this.settings.useFlash) {
            ...
            }], c, d, e = 0, f = b.length; e < f; e++) if (d = b[e].e, b[e].m.length && "object" === typeof b[e].m) for (var h = 0,
            j = b[e].m.length; h < j; h++) if (c = b[e].m[h], "" !== a.canPlayType(c)) {
                this.codecs[d] = c;
                break
...
jukebox.Player = function(a, b) {
    ...
    if ("[object Object]" === Object.prototype.toString.call(a)) for (var d in a) this.settings[d] = a[d];
...
jukebox.Player.prototype = {
    ...
    __init: function() {
        ...
        if (!0 === c.html5audio) {
            ...
            this.__initFlashContext(c); ! 0 === b.autoplay ? this.play(0) : b.spritemap[b.autoplay] && this.play(b.autoplay)
    ...
    play: function(a, b) {
        if (null !== this.isPlaying && !0 !== b) void 0 !== jukebox.Manager && jukebox.Manager.addToQueue(a, this.id);
            ...
            if (void 0 !== c[a]) d = c[a].start;
                ...
                d = a;
                for (var e in c) if (d >= c[e].start && d <= c[e].end) {
                    a = e;
                    break
                }
            }
    ...
    h.prototype = {
        ...
        _setMuted: function(a) {
            ...
            for (var b in this._howls) if (this._howls.hasOwnProperty(b) && !1 === this._howls[b]._webAudio) for (var d = 0; d < this._howls[b]._audioNode.length; d++) this._howls[b]._audioNode[d].muted = a
        }
    };
    var j = new h,
    h = null;
    ...
    q.prototype = {
        load: function() {
            ...
            if (!d) {
                ...
                if (e) {
                    ...
                    if (c._webAudio) {
                        var v = e;
                        if (v in a) c._duration = a[v].duration,
                        m(c);
                        else {
        ...
        play: function(c, d) {
            ...
            e;
            if (!e._sprite[c]) return "function" === typeof d && d(),
            e;
            e._inactiveNode(function(f) {
                ...
                z = setTimeout(function() { ! e._webAudio && m && e.stop(K.id, K.timer).play(c, K.id);
                    e._webAudio && !m && (e._nodeById(K.id).paused = !0, e._nodeById(K.id)._pos = 0); ! e._webAudio && !m && e.stop(K.id, K.timer);
                    e.on("end", q)
                },
                1E3 * l);
                ...
                } else if (4 === f.readyState) f.id = q,
                f.currentTime = h,
                f.muted = j._muted,
                f.volume = e._volume * j.volume(),
                setTimeout(function() {
                    f.play()
                },
                0);
        ...
        _inactiveNode: function(a) {
            for (var b = null,
            c = 0; c < this._audioNode.length; c++) if (this._audioNode[c].paused && 4 === this._audioNode[c].readyState) {
                a(this._audioNode[c]);
                b = !0;
                break
            }
            ...
            if (!b) {
                var d;
                this._webAudio ? (d = this._setupAudioNode(), a(d)) : (this.load(), d = this._audioNode[this._audioNode.length - 1], d.addEventListener("loadedmetadata",
                function() {
                    a(d)
                }))
            }
    ...
    a.ig = {
        ...
        copy: function(a) {
            ...
            if (a instanceof Array) for (var b = [], c = 0, d = a.length; c < d; c++) b[c] = ig.copy(a[c]);
            else for (c in b = {},
            a) b[c] = ig.copy(a[c]);
            return b
        },
        ...
        _execModules: function() {
            ...
            if (a) ig._execModules();
                ...
                for (b = 0; b < ig._loadQueue.length; b++) {
                    ...
                    for (e = 0; e < f.length; e++) c = ig.modules[f[e]],
    ...
    a.ig.Class.extend = function(b) {
        ...
        var m = new this;
        d = !1;
        for (var k in b) m[k] = "function" == typeof b[k] && "function" == typeof q[k] && e.test(b[k]) ?
        function(a, b) {
            return function() {
                var c = this.parent;
                this.parent = q[a];
...
ig.module("impact.image").defines(function() {
    ig.Image = ig.Class.extend({
        ...
        resize: function(a) {
            ...
            e.width = c;
            e.height = d;
            for (var f = e.getContext("2d"), h = f.getImageData(0, 0, c, d), j = 0; j < d; j++) for (var l = 0; l < c; l++) {
        ...
        drawTile: function(a, b, c, d, e, f, h) {
            ...
            if (this.loaded && !(d > this.width || e > this.height)) {
                ...
                m = f ? -1 : 1,
                k = h ? -1 : 1;
                if (f || h) ig.system.context.save(),
                ig.system.context.scale(m, k);
                ig.system.context.drawImage(this.data, Math.floor(c * d) % this.width * j, Math.floor(c * d / this.width) * e * j, l, q, ig.system.getDrawPos(a) * m - (f ? l: 0), ig.system.getDrawPos(b) * k - (h ? q: 0), l, q); (f || h) && ig.system.context.restore();
                ig.Image.drawCount++
            }
        }
    });
    ...
    ig.Font = ig.Image.extend({
        ...
        draw: function(a, b, c, d) {
            ...
            if ( - 1 !== a.indexOf("\n")) {
                ...
                if (d == ig.Font.ALIGN.RIGHT || d == ig.Font.ALIGN.CENTER) f = this._widthForLine(a),
                b -= d == ig.Font.ALIGN.CENTER ? f / 2 : f;
...
ig.module("impact.sound").defines(function() {
    ig.SoundManager = ig.Class.extend({
        ...
        load: function(a, b, c) {
            ...
            if (this.clips[a]) {
                if (b && this.clips[a].length < ig.Sound.channels) for (b = this.clips[a].length; b < ig.Sound.channels; b++) {
                    var e = new Audio(d);
                    e.load();
                    this.clips[a].push(e)
                }
            ...
            var f = new Audio(d);
            c && (f.addEventListener("canplaythrough",
            function j(b) {
            ...
            f.load();
            this.clips[a] = [f];
            if (b) for (b = 1; b < ig.Sound.channels; b++) e = new Audio(d),
            e.load(),
            this.clips[a].push(e);
            return f
        },
        get: function(a) {
            a = this.clips[a];
            for (var b = 0,
            c; c = a[b++];) if (c.paused || c.ended) return c.ended && (c.currentTime = 0),
            c;
            a[0].pause();
            a[0].currentTime = 0;
            return a[0]
...
ig.module("impact.system").requires("impact.timer", "impact.image").defines(function() {
    ig.System = ig.Class.extend({
        ...
        setDelegate: function(a) {
            if ("function" == typeof a.run) this.delegate = a,
            this.startRunLoop();
...
ig.module("impact.input").defines(function() {
    ...
    ig.Input = ig.Class.extend({
        ...
        keydown: function(a) {
            ...
            if (! ("INPUT" == b || "TEXTAREA" == b)) if (b = "keydown" == a.type ? a.keyCode: 2 == a.button ? ig.KEY.MOUSE2: ig.KEY.MOUSE1, ("touchstart" == a.type || "mousedown" == a.type) && this.mousemove(a), b = this.bindings[b]) this.actions[b] = !0,
        ...
        keyup: function(a) {
            var b = a.target.tagName;
            if (! ("INPUT" == b || "TEXTAREA" == b)) if (b = this.bindings["keyup" == a.type ? a.keyCode: 2 == a.button ? ig.KEY.MOUSE2: ig.KEY.MOUSE1]) this.delayedKeyup[b] = !0,
            a.stopPropagation(),
            a.preventDefault()
        },
        ...
        bindTouch: function(a, b) {
            ...
            !1);
            c.addEventListener("MSPointerDown",
            function(a) {
                d.touchStart(a, b)
            },
            !1);
            c.addEventListener("MSPointerUp",
            function(a) {
                d.touchEnd(a, b)
            },
            !1)
...
ig.module("impact.impact").requires("dom.ready", "impact.loader", "impact.system", "impact.input", "impact.sound").defines(function() {
    ig.main = function(a, b, c, d, e, f, h) {
        ...
        ig.ready = !0; (new(h || ig.Loader)(b, ig.resources)).load()
    }
});
ig.baked = !0;
    ...
    ig.Entity = ig.Class.extend({
        ...
        handleMovementTrace: function(a) {
            ...
            if (a.collision.slope) {
                ...
                } else c = (this.vel.x * b.x + this.vel.y * b.y) / (b.x * b.x + b.y * b.y),
                this.vel.x = b.x * c,
                this.vel.y = b.y * c,
                b = Math.atan2(b.x, b.y),
                b > this.slopeStanding.min && b < this.slopeStanding.max && (this.standing = !0)
            }
            this.pos = a.pos
        },
        draw: function() {
...
ig.module("impact.collision-map").requires("impact.map").defines(function() {
    ig.CollisionMap = ig.Map.extend({
        ...
        trace: function(a, b, e, f, h, j) {
            ...
            if (1 < q) for (var m = e / q,
            k = f / q,
            p = 0; p < q && (m || k) && !(this._traceStep(l, a, b, m, k, h, j, e, f, p), a = l.pos.x, b = l.pos.y, l.collision.x && (e = m = 0), l.collision.y && (f = k = 0), l.collision.slope); p++);
        ...
        _traceStep: function(a, b, e, f, h, j, l, q, m, k) {
            ...
            if (f) {
                ...
                if (0 <= f && f < this.width) for (var D = p; D < y && !( - 1 != v && (p = this.data[D][v], 1 < p && p <= this.lastSlope && this._checkTileDef(a, p, b, e, q, m, j, l, v, D))); D++) if (p = this.data[D][f], 1 == p || p > this.lastSlope || 1 < p && this._checkTileDef(a, p, b, e, q, m, j, l, f, D)) {
            ...
            if (h) {
                ...
                if (0 <= D && D < this.height) for (f = p; f < u && !( - 1 != y && (p = this.data[y][f], 1 < p && p <= this.lastSlope && this._checkTileDef(a, p, b, e, q, m, j, l, f, y))); f++) if (p = this.data[D][f], 1 == p || p > this.lastSlope || 1 < p && this._checkTileDef(a, p, b, e, q, m, j, l, f, D)) {
                    if (1 < p && p <= this.lastSlope && a.collision.slope) break;
                    a.collision.y = !0;
                    a.tile.y = p;
    ...
    ig.BackgroundMap = ig.Map.extend({
        ...
        preRenderMapToChunks: function() {
            ...
            for (var e = 0; e < d; e++) {
                ...
                for (var f = 0; f < c; f++) this.preRenderedChunks[e][f] = this.preRenderChunk(f, e, f == c - 1 ? a - f * this.chunkSize: this.chunkSize, e == d - 1 ? b - e * this.chunkSize: this.chunkSize)
            }
        },
        preRenderChunk: function(a, b, c, d) {
            ...
            c = ig.system.context;
            ig.system.context = d;
            for (d = 0; d < e; d++) for (var q = 0; q < f; q++) if (d + a < this.width && q + b < this.height) {
        ...
        drawTiled: function() {
            for (var a = 0,
            b = null,
            c = (this.scroll.x / this.tilesize).toInt(), d = (this.scroll.y / this.tilesize).toInt(), e = this.scroll.x % this.tilesize, f = this.scroll.y % this.tilesize, h = -e - this.tilesize, e = ig.system.width + this.tilesize - e, j = ig.system.height + this.tilesize - f, l = -1, f = -f - this.tilesize; f < j; l++, f += this.tilesize) {
                var q = l + d;
                ...
                for (var m = -1,
                k = h; k < e; m++, k += this.tilesize) {
                    a = m + c;
                    if (a >= this.width || 0 > a) {
                        if (!this.repeat) continue;
                        a = (a % this.width + this.width) % this.width
                    }
                    if (a = this.data[q][a])(b = this.anims[a - 1]) ? b.draw(k, f) : this.tiles.drawTile(k, f, a - 1, this.tilesize)
                }
            }
        }
    })
...
ig.module("impact.game").requires("impact.impact", "impact.entity", "impact.collision-map", "impact.background-map").defines(function() {
    ig.Game = ig.Class.extend({
        ...
        loadLevel: function(a) {
            ...
            this.backgroundMaps = [];
            for (b = 0; b < a.layer.length; b++) if (c = a.layer[b], "collision" == c.name) this.collisionMap = new ig.CollisionMap(c.tilesize, c.data);
            else {
        ...
        update: function() {
            ...
            this.updateEntities();
            this.checkEntities();
            for (var a = 0; a < this._deferredKill.length; a++) this._deferredKill[a].erase(),
            this.entities.erase(this._deferredKill[a]);
            this._deferredKill = [];
        ...
        draw: function() {
            ...
            this.drawEntities();
            for (a; a < this.backgroundMaps.length; a++) b = this.backgroundMaps[a],
            b.setScreenPos(this.screen.x, this.screen.y),
            b.draw()
        },
        ...
        checkEntities: function() {
            for (var a = {},
            b = 0; b < this.entities.length; b++) {
                var c = this.entities[b];
                if (! (c.type == ig.Entity.TYPE.NONE && c.checkAgainst == ig.Entity.TYPE.NONE && c.collides == ig.Entity.COLLIDES.NEVER)) for (var d = {},
                e = Math.floor(c.pos.y / this.cellSize), f = Math.floor((c.pos.x + c.size.x) / this.cellSize) + 1, h = Math.floor((c.pos.y + c.size.y) / this.cellSize) + 1, j = Math.floor(c.pos.x / this.cellSize); j < f; j++) for (var l = e; l < h; l++) if (a[j]) if (a[j][l]) {
...
ig.module("plugins.windowfocus-onMouseDown-patch").requires("impact.input").defines(function() {
    ig.Input.keydown = function(a) {
        var b = a.target.tagName;
        if (! ("INPUT" == b || "TEXTAREA" == b)) if (b = "keydown" == a.type ? a.keyCode: 2 == a.button ? ig.KEY.MOUSE2: ig.KEY.MOUSE1, 0 > b && window.focus(), ("touchstart" == a.type || "mousedown" == a.type) && this.mousemove(a), b = this.bindings[b]) this.actions[b] = !0,
        this.locks[b] || (this.presses[b] = !0, this.locks[b] = !0),
        a.stopPropagation(),
        a.preventDefault()
    }
...
ig.module("plugins.font-loaded-test").defines(function() {
    ig.FontLoadedTest = ig.Class.extend({
        testFont: function(a) {
            ...
            a = b(a + ",arial");
            for (var e = b("arial"), f = !1, h = 0; h < a.data.length; h++) if (a.data[h] != e.data[h]) {
                f = !0;
                break
            }
            return ! f ? !1 : !0
...
ig.module("game.loader.splash-loader").requires("impact.loader", "impact.animation", "plugins.font-loaded-test").defines(function() {
    ig.SplashLoader = ig.Loader.extend({
        ...
        update: function() {
            ...
            1 == this.loadingStage && this.fontTester.testFont(this.font) && (this.loadingStage = 2, ig.domHandler.hide(ig.domHandler.getElementById("#ajaxbar")))
        },
        draw: function() {
            this.update();
            if (1 >= this.loadingStage) ig.system.context.font = "24px " + this.font,
...
ig.module("game.components.director").defines(function() {
    ig.Director = ig.Class.extend({
        ...
        append: function(a) {
            newLevels = [];
            return "object" === typeof a ? (a.constructor === [].constructor ? newLevels = a: newLevels[0] = a, this.levels = this.levels.concat(newLevels), !0) : !1
        },
        nextLevel: function() {
...
ig.module("game.components.tween").requires("impact.entity").defines(function() {
    ...
    ig.Tween.Easing.Elastic.EaseIn = function(a) {
        ...
        if (0 == a) return 0;
        if (1 == a) return 1;
        d || (d = 0.3); ! c || 1 > c ? (c = 1, b = d / 4) : b = d / (2 * Math.PI) * Math.asin(1 / c);
...
ig.module("game.components.drawer").defines(function() {
    Drawer = ig.Class.extend({
        ...
        roundRect: function(a, b, c, d, e, f) {
            ...
            if (d || c) this.context.beginPath(),
            this.context.moveTo(a + e, b),
            this.context.lineTo(a + width - e, b),
            this.context.quadraticCurveTo(a + width, b, a + width, b + e),
            this.context.lineTo(a + width, b + height - e),
            this.context.quadraticCurveTo(a + width, b + height, a + width - e, b + height),
            this.context.lineTo(a + e, b + height),
            this.context.quadraticCurveTo(a, b + height, a, b + height - e),
            this.context.lineTo(a, b + e),
            this.context.quadraticCurveTo(a, b, a + e, b),
            this.context.closePath(),
            d && this.context.stroke(),
            c && this.context.fill()
        },
        createGradient: function(a, b, c, d, e) {
            a = this.context.createLinearGradient(a, b, c, d);
            for (b = 0; b < e.length; b++) a.addColorStop(b, e[b]);
            return a
        },
...
ig.module("game.sound.impact-music-player").requires("game.sound.sound-player").defines(function() {
    ImpactMusicPlayer = SoundPlayer.extend({
        ...
        init: function(a, b) {
            this.parent(a, b);
            for (var c in a) this.soundList[c] = c,
            ig.music.add(a[c].path + ".*", c);
...
ig.module("game.sound.impact-sound-player").requires("game.sound.sound-player").defines(function() {
    ImpactSoundPlayer = SoundPlayer.extend({
        ...
        volume: function(a) {
            ig.soundManager.volume = 0 > a ? 0 : isNaN(a) ? 1 : 1 < a ? 1 : a
        },
        getVolume: function() {
...
ig.module("game.sound.howler-music-player").requires("game.sound.sound-player").defines(function() {
    HowlerMusicPlayer = SoundPlayer.extend({
        ...
        play: function(a) {
            if (!this.muteFlag && !this.bgmPlaying) if ("object" === typeof a) this.bgmPlaying = !0,
            a.play();
            else if ("string" === typeof a) this.bgmPlaying = !0,
            this.soundList[a].play();
            else for (var b in this.soundList) {
    ...
    WebaudioMusicPlayer = SoundPlayer.extend({
        ...
        init: function(a, b) {
            ...
            for (var h in a) {
                ...
                l.onload = function() {
                    this.webaudio.context.decodeAudioData(l.response,
                    function(a) {
        ...
        initIOSWebAudioUnlock: function() {
            var a = function() {
                ...
                setTimeout(function() { (d.playbackState === d.PLAYING_STATE || d.playbackState === d.FINISHED_STATE) && window.removeEventListener("touchend", a, !1)
                },
                0)
            };
        ...
        play: function() {
            if (this.isSupported) if (this.webaudio.buffer) {
                if (!this.muteFlag && (this.bgmPlaying = !0, !this.webaudio.source_loop._playing)) {
                    ...
                    this.webaudio.source_once.noteGrainOn(0, a, this.webaudio.buffer.duration - a),
                    this.webaudio.source_loop[this.webaudio.compatibility.start](this.webaudio.context.currentTime + (this.webaudio.buffer.duration - a));
...
ig.module("game.handlers.dom-handler").defines(function() {
    ig.DomHandler = ig.Class.extend({
        ...
        resize: function(a, b, c) {
            if (this.JQUERYAVAILABLE) a.width(b.toFixed(2)),
            a.height(c.toFixed(2));
            else {
...
ig.module("game.handlers.size-handler").requires("game.data.vector").defines(function() {
    ig.SizeHandler = ig.Class.extend({
        ...
        sizeCalcs: function() {
            ...
            a = new Vector2(this.desktop.actualResolution.x, this.desktop.actualResolution.y),
            this.scaleRatioMultiplier = new Vector2(this.desktop.actualSize.x / a.x, this.desktop.actualSize.y / a.y),
            b = Math.min(this.scaleRatioMultiplier.x, this.scaleRatioMultiplier.y),
            this.desktop.actualSize.x = a.x * b,
            this.desktop.actualSize.y = a.y * b;
        ...
        resizeLayers: function() {
            ...
            for (var c in this.adsToResize) {
                var a = ig.domHandler.getElementById("#" + c),
...
ig.module("game.io.gamepad-input").defines(function() {
    ...
    ig.GamepadInput = ig.Class.extend({
        ...
        buttonPressed: function(a) {
            return "object" == typeof a ? a.pressed: 1 == a
        },
        buttonDown: function(a) {
            if (a = this.bindings[a]) this.states[a] = !0,
            this.downLocks[a] || (this.presses[a] = !0, this.downLocks[a] = !0)
        },
        buttonUp: function(a) {
            if ((a = this.bindings[a]) && this.downLocks[a] && !this.upLocks[a]) this.states[a] = !1,
            this.releases[a] = !0,
            this.upLocks[a] = !0
        },
        clearPressed: function() {
            for (var a in this.releases) this.states[a] = !1,
            this.downLocks[a] = !1;
            this.releases = {};
            this.presses = {};
            this.upLocks = {}
        ...
        pollGamepads: function() {
            if (this.isSupported) {
                ...
                for (c = 0; c < this.list.length; c++) if ((d = this.list[c]) && d.axes) {
...
ig.module("game.io.gamepad").requires("game.io.gamepad-input").defines(function() {
    Gamepad = ig.Class.extend({
        ...
        init: function() {
            ...
            for (var a in this.bindings) for (var b = 0; b < this.bindings[a].length; b++) ig.gamepadInput.bind(this.bindings[a][b], a)
        },
        press: function() {},
        held: function() {},
        release: function() {}
    ...
    ig.MultitouchInput = ig.Class.extend({
        ...
        touchmove: function(a) {
            if (ig.ua.touchDevice) {
                ...
                c = ig.system.scale * (c / ig.system.realHeight);
                if (a.touches) {
                    for (; 0 < this.touches.length;) this.touches.pop(); ! this.multitouchCapable && 1 < a.touches.length && (this.multitouchCapable = !0);
                    var d = {
                        left: 0,
                        top: 0
                    };
        ...
        touchup: function(a) {
            ...
            if (window.navigator.msPointerEnabled) this.windowKeyUp(a);
                ...
                if (ig.ua.touchDevice) {
                    a = (a.changedTouches[0].clientX - c.left) / b;
        ...
        windowKeyUp: function(a) {
            a = "undefined" != typeof a.identifier ? a.identifier: "undefined" != typeof a.pointerId ? a.pointerId: 1;
        ...
        windowMove: function(a) {
            ...
            ig.system.canvas.getBoundingClientRect && (d = ig.system.canvas.getBoundingClientRect());
            if (window.navigator.msPointerEnabled) for (var e = "undefined" != typeof a.identifier ? a.identifier: "undefined" != typeof a.pointerId ? a.pointerId: 1, f = 0; f < this.touches.length; ++f) if (this.touches[f].identifier == e) {
...
ig.module("game.io.io-manager").requires("game.io.storage", "game.io.mouse", "game.io.keyboard", "game.io.gamepad", "game.io.multitouch", "game.io.multitouch-input", "game.io.gamepad-input").defines(function() {
    IoManager = ig.Class.extend({
        ...
        release: function(a) {
            return ig.input.released(a) || this.gamepad.released(a) ? !0 : !1
        },
        ...
        storageIsSet: function(a) {
            return ! this.localStorageSupport ? null: this.storage.isSet(a)
        },
...
ig.module("plugins.fade-transition").defines(function() {
    ig.FadeTransition = ig.Class.extend({
        ...
        drawTransition: function() {
            if (this.transitionFadein || this.transitionFadeout) this.overlayAlpha > this.targetOverlayAlpha && (this.overlayAlpha = this.targetOverlayAlpha),
        ...
        startFadeoutTransition: function() {
            this.transitionFadeout || (this.transitionFadeout = !0, this.transitionTime = ig.system.clock.delta(), this.overlayAlpha = 0)
        }
    })
});
ig.baked = !0;
ig.module("plugins.sat").defines(function() {
    ig.SAT = ig.Class.extend({
        ...
        mtvForShapeIntersect: function(a, b) {
            ...
            for (h = 0; h < e.length; h++) {
                ...
                if (m.overlap(k)) {
                    l = m.getOverlap(k);
                    if (m.contains(k) || k.contains(m)) q = Math.abs(m.min - k.min),
                    m = Math.abs(m.max - k.max),
                    l = q < m ? l + q: l + m;
                    l < c && (c = l, d = j)
                } else return null
            }
            for (h = 0; h < f.length; h++) if (j = f[h], m = a.project(j), k = b.project(j), m.overlap(k)) {
                l = m.getOverlap(k);
                if (m.contains(k) || k.contains(m)) q = Math.abs(m.min - k.min),
                m = Math.abs(m.max - k.max),
                l = q < m ? l + q: l + m;
        ...
        simpleShapeIntersect: function(a, b) {
            ...
            } else c = a.getNormalizedAxes(),
            d = b.getNormalizedAxes();
            for (e = 0; e < c.length; e++) if (h = c[e], f = a.project(h), h = b.project(h), !f.overlap(h)) return ! 1;
            for (e = 0; e < d.length; e++) if (h = d[e], f = a.project(h), h = b.project(h), !h.overlap(f)) return ! 1;
            return ! 0
        }
    });
    ig.SAT.Vector2D = ig.Class.extend({
        ...
        normalized: function() {
            ...
            return 0 == a ? new ig.SAT.Vector2D(0, 0) : new ig.SAT.Vector2D(this.x / a, this.y / a)
        },
        distance: function(a) {
            var b = a.x - this.x;
            a = a.y - this.y;
    ...
    ig.SAT.Shape = ig.Class.extend({
        ...
        getAxes: function() {
            ...
            if (2 == this.pointList.length) {
                ...
                c = this.pointList[1],
                b = b.subtract(c),
                b = b.getNormal(); (0 != b.x || 0 != b.y) && a.push(b);
                return a
            }
            for (var d = 0; d < this.pointList.length; d++) b = this.pointList[d],
            c = this.pointList[d + 1 == this.pointList.length ? 0 : d + 1],
            b = b.subtract(c),
            b = b.getNormal(),
        ...
        getNormalizedAxes: function() {
            for (var a = [], b = 0; b < this.pointList.length; b++) {
                var c = this.pointList[b].subtract(this.pointList[b + 1 == this.pointList.length ? 0 : b + 1]).getNormalizedNormal(); (0 != c.x || 0 != c.y) && a.push(c)
            }
            return a
        },
        project: function(a) {
...
ig.module("plugins.button").requires("plugins.sat").defines(function() {
    ig.Button = ig.Class.extend({
        ...
        setPosRelativeTo: function(a, b) {
            if (a && a.pos && !(null == a.pos.x || null == a.pos.y)) this.posRelativeTo = a,
            this.setPos(b)
        },
        setRect: function(a) {
        ...
        setText: function(a) {
            isNaN(a) || (a = "" + a);
            this.text = a;
            this.textWrap && 1 <= this.rect.w ? (this.textList = this.wrapText(a, this.rect.w), this.textHeightAdjustment = 0.8 * this.textLineHeight - this.textList.length / 2 * this.textLineHeight) : (this.textList = null, this.textHeightAdjustment = 0.8 * this.textLineHeight)
        },
        ...
        setDownImage: function(a) {
            if (this.downImage = a) this.buttonType = ig.BUTTONTYPE.IMAGE
        },
        ...
        draw: function() {
            if (!this.hidden) {
                ...
                this.image ? (b = this.imageOffset.x - this.image.width / 2, c = this.imageOffset.y - this.image.height / 2, this.antialiasingEnabled || (b = this.bitwiseRound(b), c = this.bitwiseRound(c)), this.image.draw(b, c)) : this.anim && (b = this.imageOffset.x - this.anim.sheet.width / 2, c = this.imageOffset.y - this.anim.sheet.height / 2, this.antialiasingEnabled || (b = this.bitwiseRound(b), c = this.bitwiseRound(c)), this.anim.draw(b, c));
                d = !1;
                this.textOnlyOnHover && (!this.over && !this.down) && (d = !0);
                if (!d && this.textShadowDisabled && this.text && "" != this.text) if (a.font = this.textFontSize + "px " + this.textFont, a.textAlign = "center", b = this.textOffset.x, c = this.textOffset.y, c += this.textHeightAdjustment, this.antialiasingEnabled || (b = this.bitwiseRound(b), c = this.bitwiseRound(c)), a.transform(this.textScale.x, this.textSkew.x, this.textSkew.y, this.textScale.y, b, c), a.rotate(this.textAngle), this.textList) for (c = b = 0; c < this.textList.length; c++) a.fillStyle = this.getTextColorStr(),
                a.fillText(this.textList[c], 0, b),
                b += this.textLineHeight;
                else a.fillStyle = this.getTextColorStr(),
                a.fillText(this.text, 0, 0);
                a.restore(); ! d && !this.textShadowDisabled && this.drawTextShadow()
            }
        },
        drawDebug: function() {
            var a = ig.system.context;
        ...
        update: function() {
            if (!this.disabled) if (this.pointerInputOverlap() || this.keyInputReleased()) {
                if (this.over = this.down = !1, this.scaleMultiplier = 1, ig.ua.mobile || (this.over = !0, this.scaleMultiplier = this.overScaleMultiplier), this.clickInputDetected() && (this.down = !0, this.over = !1, this.scaleMultiplier = this.downScaleMultiplier), this.clickInputReleased() || this.keyInputReleased()) this.over = this.down = !1,
                this.scaleMultiplier = 1,
                ig.ua.mobile || (this.over = !0, this.scaleMultiplier = this.overScaleMultiplier),
                "function" === typeof this.clickedFunction && this.clickedFunction(this)
            } else this.over = this.down = !1,
            this.scaleMultiplier = 1
        },
        ...
        drawBtnShadow: function() {
            ...
            a.rotate(this.angle);
            if (this.buttonType == ig.BUTTONTYPE.ROUNDED_RECT || this.buttonType == ig.BUTTONTYPE.SQUARE_RECT || this.buttonType == ig.BUTTONTYPE.OCTOGON || this.buttonType == ig.BUTTONTYPE.PILL || this.buttonType == ig.BUTTONTYPE.CIRCLE) if (a.strokeStyle = this.strokeStyle, a.fillStyle = this.btnShadowColor, c = b = !1, this.strokeStyle && 0 < this.strokeWidth && (c = !0, a.lineWidth = this.strokeWidth), this.fillStyle && (b = !0), this.buttonType == ig.BUTTONTYPE.SQUARE_RECT) if (b && c) {
        ...
        drawTextShadow: function() {
            ...
            a.transform(this.scale.x * this.scaleMultiplier, this.skew.x, this.skew.y, this.scale.y * this.scaleMultiplier, b, c);
            a.rotate(this.angle);
            if (this.text && "" != this.text) if (a.font = this.textFontSize + "px " + this.textFont, a.textAlign = "center", b = this.textOffset.x, c = this.textOffset.y, c += this.textHeightAdjustment, this.antialiasingEnabled || (b = this.bitwiseRound(b), c = this.bitwiseRound(c)), a.transform(this.textScale.x, this.textSkew.x, this.textSkew.y, this.textScale.y, b, c), a.rotate(this.textAngle), this.textList) for (c = b = 0; c < this.textList.length; c++) a.fillStyle = this.textShadowColor,
            a.fillText(this.textList[c], 0, b),
            b += this.textLineHeight;
            else a.fillStyle = this.textShadowColor,
            a.fillText(this.text, 0, 0);
            a.restore();
            b = this.pos.x + this.offset.x;
            c = this.pos.y + this.offset.y;
        ...
        wrapText: function(a, b) {
            ...
            e = "",
            f = [];
            if (1 == d.length) for (var h = 0; h < a.length; h++) {
                var j = e + a[h],
                l = c.measureText(j),
                l = l.width;
                l > b && 0 < h ? (f.push(e), e = a[h]) : e = j
            } else for (h = 0; h < d.length; h++) j = e + d[h] + " ",
            l = c.measureText(j),
            l = l.width,
            l > b && 0 < h ? (f.push(e), e = d[h] + " ") : e = j;
            f.push(e);
            return f
        },
...
ig.module("game.components.clickable-div-layer").requires("game.data.vector").defines(function() {
    ClickableDivLayer = ig.Class.extend({
        ...
        update: function(a, b) {
            this.pos.x === a && this.pos.y === b || (ig.sizeHandler.dynamicClickableEntityDivs[this.identifier] = {},
...
ig.module("game.entities.button-more-games").requires("impact.entity", "game.components.clickable-div-layer").defines(function() {
    EntityButtonMoreGames = ig.Entity.extend({
        ...
        show: function() {
            this.divLayerName && (id = this.divLayerName, document.getElementById(id).style.visibility = "visible", $("#" + id).show())
        },
        kill: function() {
            this.parent();
            this.hide()
    ...
    ClickableDivLayerBranding = ig.Class.extend({
        ...
        createClickableOutboundLayer: function(a, b, c, d) {
            ...
            if (ig.ua.mobile) {
                ...
                j = Math.floor(this.size.x * ig.sizeHandler.scaleRatioMultiplier.x) + "px";
                c = Math.floor(this.size.y * ig.sizeHandler.scaleRatioMultiplier.y) + "px"
            } else d = ig.domHandler.getElementById("#canvas"),
            d = ig.domHandler.getOffsets(d),
            h = d.top,
            d = Math.floor(d.left + this.pos.x * c) + "px",
            h = Math.floor(h + this.pos.y * c) + "px",
            j = Math.floor(this.size.x * c) + "px",
...
ig.module("game.classes.options-panel").requires("plugins.button").defines(function() {
    OptionsPanel = ig.Class.extend({
        ...
        ready: function() {
            ...
            d.setFont(14, "bachelorpadjl, Impact, Charcoal, sans-serif"), b = _STRINGS.UI.TUTORIAL, addTextSpacing && (b = b.split("").join(String.fromCharCode(8202))), d.setText(b), d.textOffset.x = 2, d.textOffset.y = 60, d.textShadowDisabled = !1, d.textShadowColor = "rgba(255,255,255,0.5)", d.textShadowOffset = {
                x: 1,
                y: 1
            },
            ...
            d.setFont(14, "bachelorpadjl, Impact, Charcoal, sans-serif"), b = _STRINGS.UI["MAIN MENU"], addTextSpacing && (b = b.split("").join(String.fromCharCode(8202))), d.setText(b), d.textOffset.x = 2, d.textOffset.y = 60, d.textShadowDisabled = !1, d.textShadowColor = "rgba(255,255,255,0.5)", d.textShadowOffset = {
                x: 1,
                y: 1
            },
        ...
        showDone: function() {},
        hide: function() {
            if (!this.hidden && !this.transitionOut) if (this.transitionOut = !0, this.transitionIn) {
                this.transitionIn = !1;
                var a = ig.system.clock.delta() - this.transitionTime;
        ...
        soundButtonPressed: function() {
            1 > ig.game.sfxVolume ? (this.setSfxVolume(1), this.soundButton.setImage(this.soundOnImage), ig.soundHandler.sfxPlayer.play("button")) : (this.setSfxVolume(0), this.soundButton.setImage(this.soundOffImage))
        },
    ...
    EntityHomeControl = ig.Entity.extend({
        ...
        ready: function() {
            if (!ig.global.wm) {
                ...
                d.buttonType = ig.BUTTONTYPE.IMAGE;
                d.setImage(a);
                this.optionsButton = d; (!this.moregames || this.moregames._killed) && this.optionsButton.setPos({
                    x: 420,
                    y: 580
                });
...
ig.module("plugins.number-anim").defines(function() {
    ig.NumberAnim = ig.Class.extend({
        ...
        add: function(a) {
            isNaN(a) || (this.actualValue += a, this.actualValue < this.minValue && (this.actualValue = this.minValue), this.actualValue >= this.maxValue && (this.actualValue = this.maxValue), this.animStartTime = ig.system.clock.delta(), this.animStartValue = this.displayValue)
        },
        setMin: function(a) {
            this.minValue = a;
            this.hasMin = !0
...
ig.module("plugins.textwrapper").defines(function() {
    ig.Textwrapper = ig.Class.extend({
        ...
        drawTextList: function(a, b, c) {
            if (a && a.length && !(0 >= a.length)) for (var d = ig.system.context,
            e = 0,
            f = 0; f < a.length; f++) d.fillText(a[f], b, c + e),
            e += this.textLineHeight
        }
    })
});
ig.baked = !0;
ig.module("game.classes.ui").requires("plugins.button", "plugins.textwrapper").defines(function() {
    Ui = ig.Class.extend({
        ...
        initButtons: function() {
            ...
            for (var h = this.abilityBarRect.y + this.abilityBarRect.h / 2,
            j = this.abilityBarRect.x + this.abilityBarRect.w / 2 - a / 2,
            e = 0; e < this.abilityButtonMetaList.length; e++) f = this.abilityButtonMetaList[e],
            f.x = j + f.image.width / 2,
            f.y = h,
            this.abilityButtonMetaList[e] = f,
            a = f.image,
            b = a.width,
            c = a.height,
            d = new ig.Button(this),
            ...
            d.clickedFunction = this.abilityButtonPressed.bind(this),
            d.downOffset = {
                x: 0,
                y: 1
            },
            ...
            d.buttonType = ig.BUTTONTYPE.IMAGE,
            d.setImage(a),
            this.abilityQuickbuyButtonList.push(d),
            j += f.image.width + 25
        },
        draw: function() {
            this.drawWhiteout();
        ...
        drawAbilityBar: function() {
            for (var a = 0; a < this.abilityButtonList.length; a++) this.drawButtonGlow(this.abilityButtonList[a]),
            this.abilityButtonList[a].draw(),
            this.drawAbilityCount(this.abilityButtonList[a]),
            this.drawAbilityCooldownBar(this.abilityButtonList[a]),
            this.control.abilities[a].buyCost <= this.control.gameGold.actualValue && this.abilityQuickbuyButtonList[a].draw()
        },
        update: function() {
            ...
            if (!this.control.gameOver && this.control.shop.hidden && this.control.options.hidden) {
                for (var a = 0; a < this.abilityButtonList.length; a++) this.abilityButtonList[a].update(),
                this.control.abilities[a].buyCost <= this.control.gameGold.actualValue && (this.abilityQuickbuyButtonList[a].setText(_STRINGS.UI.BUY), !this.abilityButtonList[a].disabled && !this.shopButton.disabled && this.abilityQuickbuyButtonList[a].update());
        ...
        drawWhiteout: function() {
            this.control.whiteoutFlag && (ig.system.context.globalAlpha = 0.5 * this.control.whiteoutAlpha, ig.system.context.fillStyle = "#ff0000", ig.system.context.fillRect(0, 0, ig.system.width, ig.system.height), ig.system.context.globalAlpha = 1)
        },
        drawGold: function() {
...
ig.module("plugins.tutorial-box").defines(function() {
    ig.TutorialBox = ig.Class.extend({
        ...
        setMessages: function(a) {
            if (a && a.length) {
                ...
                if (a.constructor === Array) {
                    for (var c = !0,
                    b = 0; b < a.length; b++) if ("string" != typeof a[b]) {
                        c = !1;
                        break
                    }
                    if (c) for (b = 0; b < a.length; b++) c = {},
                    c.message = a[b],
                    this.textWrap && 0 < this.textRect.w && (c.wrappedMessage = this.wrapText(c.message, this.textRect.w, this.textFontSize, this.textFont)),
                    c.
                    continue = !0,
                    this.stages.push(c)
                }
        ...
        update: function() {
            if (this.bgStateId == this.bgStates.showing) if (this.bgTime < this.bgShowDuration) {
            ...
            if (this.textStateId == this.textStates.showing) if (this.textTime < this.textShowDuration ? (this.textAlpha = a = this.textTime / this.textShowDuration, this.textTime += ig.system.tick) : this.textAlpha = 1, a = this.getCurStage(), a = a.message, this.textHScrollPos < a.length) {
            ...
            } else this.textHScrollPos = a.length,
            1 == this.textAlpha && (this.textTime = 0, this.textStateId = this.textStates.shown);
            else this.textStateId == this.textStates.shown ? (a = this.getCurStage(), a.
            continue && this.bgStateId == this.bgStates.shown && (this.textNextTime += ig.system.tick, this.textNextAlpha = this.textNextTime % 2, 1 < this.textNextAlpha && (this.textNextAlpha = 2 - this.textNextAlpha), this.detectPlayerInput() && (b = this.getInputPos(), c = {},
            c.x = b.x, c.y = b.y, c.w = 1, c.h = 1, b = {},
            b.x = this.pos.x + this.rect.x, b.y = this.pos.y + this.rect.y, b.w = this.rect.w, b.h = this.rect.h, this.aabbCheck(c, b) ? this.gotoNextStage() : (this.textStateId == this.textStates.showing || this.textStateId == this.textStates.shown) && 0.5 < this.textNextTime && this.gotoNextStage()))) : this.textStateId == this.textStates.hiding && (this.textTime < this.textHideDuration ? (a = this.textTime / this.textHideDuration, this.textAlpha = 1 - a, this.textTime += ig.system.tick) : (this.textAlpha = this.textTime = 0, this.textStateId = this.textStates.hidden, this.curStageId + 1 < this.stages.length ? (this.gotoNextStage(), this.textStateId = this.textStates.showing, this.textHScrollPos = 0) : this.bgStateId = this.bgStates.hiding))
        },
        getCurStage: function() {
            if (this.curStageId < this.stages.length) return this.stages[this.curStageId]
        },
        gotoNextStage: function() {
            this.textStateId == this.textStates.showing || this.textStateId == this.textStates.shown ? (this.textStateId = this.textStates.hiding, this.textNextTime = this.textNextAlpha = 0) : this.textStateId == this.textStates.hidden && this.curStageId + 1 < this.stages.length && (this.curStageId += 1)
        },
        show: function() {
        ...
        drawScrollText: function() {
            if (this.textAlpha) {
                for (var a = ig.system.context,
                b = this.pos.x + this.rect.x + this.textPos.x + this.textRect.x,
                c = this.pos.y + this.rect.y + this.textPos.y,
                d = this.alpha * this.bgAlpha * this.textAlpha,
                e = this.getCurStage(), f = e.wrappedMessage, h = this.textHScrollPos, j = 0; j < f.length; j++) {
                    var l = f[j];
        ...
        wrapText: function(a, b, c, d) {
            ...
            d = "";
            var f = [];
            if (1 == c.length) for (var h = 0; h < a.length; h++) {
                var j = d + a[h],
                l = e.measureText(j),
                l = l.width;
                l > b && 0 < h ? (f.push(d), d = a[h]) : d = j
            } else for (h = 0; h < c.length; h++) j = d + c[h] + " ",
            l = e.measureText(j),
            l = l.width,
            l > b && 0 < h ? (f.push(d), d = c[h] + " ") : d = j;
            f.push(d);
            return f
        },
        getTextColorStr: function() {
...
ig.module("game.classes.tutorial").requires("plugins.button", "plugins.textwrapper", "plugins.tutorial-box").defines(function() {
    Tutorial = ig.Class.extend({
        ...
        init: function(a) {
            ...
            this.tutorialBox.stages[0].
            continue = !1;
            this.tutorialBox.stages[1].
            continue = !1;
            this.tutorialBox.stages[3].
            continue = !1;
            this.tutorialBox.stages[4].
            continue = !1;
            this.tutorialBox.stages[6].
            continue = !1;
            this.tutorialBox.stages[7].
            continue = !1;
            this.tutorialBox.stages[8].
            continue = !1;
            this.tutorialBox.stages[9].
            continue = !1;
            this.tutorialBox.stages[10].
            continue = !1;
            this.tutorialBox.stages[12].
            continue = !1;
            this.tutorialBox.stages[13].
            continue = !1;
        ...
        updateFinger: function() {
            if (this.showFingerFlag) {
                ...
                0.5 < a && (a = 1 - a); ! this.fingerPos.dir || 1 == this.fingerPos.dir ? (this.fingerOffset.x = 0, this.fingerOffset.y = -20 * a / 0.5) : (this.fingerOffset.x = -20 * a / 0.5, this.fingerOffset.y = 0);
        ...
        updateStages: function() {
            if (0 == this.tutorialBox.curStageId) {
            ...
            } else if (1 == this.tutorialBox.curStageId) if (this.targetPickup) {
                ...
                d.x = c.x,
                d.y = c.y,
                this.control.aabbCheck(b, d) && (a.hit(), this.showFingerFlag = !1, this.targetPickup = null, this.tutorialBox.gotoNextStage(), this.spawnSurpriseMonsters())
            } else 0 < this.control.pickups.length && (a = this.control.pickups[0], a.aliveDuration = 0, this.targetPickup = a);
            else if (2 != this.tutorialBox.curStageId) if (3 == this.tutorialBox.curStageId) if (this.targetAbility && this.targetButton) {
                if (this.fingerPos.x = this.targetButton.pos.x, this.fingerPos.y = this.targetButton.pos.y - 20 - 10, this.tutorialBox.textStateId == this.tutorialBox.textStates.showing && !this.showFingerFlag && (this.showFingerFlag = !0, this.fingerPriority = 1, this.targetButton.enable()), this.targetAbility.onCooldown()) {
                    ...
                    for (b = 0; b < this.control.monsters.length; b++) a = this.control.monsters[b],
                    a.setStateId(a.states.attack)
                }
        ...
        spawnSurpriseMonsters: function() {
            ...
            mon.dropShake = 0.1,
            this.control.monsterSpawnQueue.push({
                time: 2,
                monster: mon
            }),
            mon.attackOnce = !0,
            ...
            this.control.monsters.push(mon),
            mon.attackOnce = !0,
            mon.forceDropId = -1,
            mon.damage = 3
        },
        spawnStartMonster: function() {
            ...
            this.control.monsters.push(mon),
            this.targetMonster = mon,
            mon.attackDisabled = !0,
            mon.wanderDisabled = !0,
            mon.forceDropId = 0
        },
    ...
    GameoverPanel = ig.Class.extend({
        ...
        draw: function() {
            if (!this.hidden) {
                ...
                this.bgImage.draw(b, c);
                a.restore();
                if (this.safetyTime >= this.safetyDuration) this.mainmenuButton.draw(),
        ...
        update: function() {
            if (!this.hidden) if (this.transitionIn) {
                var a = ig.system.clock.delta() - this.transitionTime,
                a = a / this.transitionDuration;
                1 < a && (a = 1);
                this.alpha = a;
    ...
    ShopPanel = ig.Class.extend({
        ...
        drawItemCards: function() {
            ...
            if (! (0 > this.selectedItemId || this.selectedItemId >= this.control.abilities.length)) {
                ...
                if ((c = this.itemList[c]) && c.image) a = c.image,
                d = this.pos.x - a.width / 2 + h,
                e = this.pos.y + 20 - a.height / 2 + j,
                a.draw(d, e),
                a = this.greenBgImage,
                d += 86,
                e += 7,
...
ig.module("plugins.image-manipulation").requires("impact.image").defines(function() {
    ig.Image.inject({
        ...
        filter_grayscale: function(a) {
            for (var b = a.data,
            c = 0; c < b.length; c += 4) b[c] = b[c + 1] = b[c + 2] = 0.2126 * b[c] + 0.7152 * b[c + 1] + 0.0722 * b[c + 2];
            return a
        },
        ...
        filter_screen: function(a) {
            for (var b = this.path.indexOf("#"), c = a.data, d, e = c.length, f = parseInt(this.path.substr(b + 1, 2), 16) / 255, h = parseInt(this.path.substr(b + 3, 2), 16) / 255, b = parseInt(this.path.substr(b + 5, 2), 16) / 255, j = 0; j < e; j += 4) {
                d = c[j + 3] / 255;
                var l = c[j] / 255 * d,
                q = c[j + 1] / 255 * d,
                m = c[j + 2] / 255 * d;
...
ig.module("game.classes.character").requires("plugins.number-anim", "plugins.image-manipulation", "plugins.rumbler").defines(function() {
    Character = ig.Class.extend({
        ...
        init: function(a, b) {
            ...
            this.hitRect.h = this.idleAnim.sheet.height - 50;
        ...
        getEnergyDisplayPercentage: function() {
            return 0 >= this.maxEnergy ? 0 : this.energy.displayValue / this.maxEnergy
        },
        ...
        updateHitEffect: function() {
            0 > this.hitEffectTime || (this.hitEffectTime += ig.system.tick, this.hitEffectTime >= this.hitEffectDuration ? (this.hitEffectTime %= this.hitEffectDuration, this.hitEffectTime = -1, this.hitEffectAlpha = 1) : this.hitEffectAlpha = 1 - this.hitEffectTime / this.hitEffectDuration)
        },
        ...
        midMegaSlash: function() {
            if (!this.midMegaSlashDone) {
                ...
                for (var a = 0; a < this.control.monsters.length; a++) {
                    var b = this.control.monsters[a]; ! b.isBoss && ( - 46 < b.pos.x && b.pos.x < ig.system.width + 46 && -46 < b.pos.y && b.pos.y < ig.system.height + 46) && (b.hit(), this.control.addSlash(b.pos.x, b.pos.y + b.imageOffset.y / 2))
                }
            }
        },
        ...
        takeDamage: function(a, b) {
            if (!isNaN(a) && !(this.stateId == this.states.dying || this.stateId == this.states.dead) && !(0 <= this.shieldTime)) this.health.add( - a),
            0 >= this.health.actualValue ? (this.die(), this.control.heroHitLethal(b)) : this.control.heroHit(b),
            this.control.addFloatingText(this.pos.x, this.pos.y - 50, "" + Math.floor(a), "#ff0000")
        },
...
ig.module("game.classes.pickup").requires("plugins.image-manipulation", "plugins.rumbler").defines(function() {
    Pickup = ig.Class.extend({
        ...
        draw: function() {
            this.stateId == this.states.spawn ? this.drawSpawn() : this.stateId == this.states.hit ? this.drawHitEffect() : this.stateId == this.states.idle ? this.drawIdle() : this.stateId == this.states.despawn && this.drawDespawn()
        },
        drawShadow: function() {
        ...
        updateSpawn: function() {
            if (! (0 > this.spawnTime)) if (this.spawnTime += ig.system.tick, this.spawnTime >= this.spawnDuration) this.spawnTime %= this.spawnDuration,
            this.spawnTime = -1,
            this.spawnScale = this.spawnAlpha = 1,
        ...
        updateIdle: function() {
            this.updateBounce();
            if (0 < this.aliveDuration) if (this.aliveTime += ig.system.tick, this.aliveTime >= this.aliveDuration) this.setStateId(this.states.despawn),
            this.despawnTime = 0,
            this.despawnWarningAlpha = 1;
            else {
        ...
        updateHitEffect: function() {
            0 > this.hitEffectTime || (this.hitEffectTime += ig.system.tick, this.hitEffectTime >= this.hitEffectDuration ? (this.hitEffectTime %= this.hitEffectDuration, this.hitEffectTime = -1, this.hitEffectAlpha = 0.5) : this.hitEffectAlpha = 1 - 0.5 * (this.hitEffectTime / this.hitEffectDuration))
        },
        updateCollect: function() {
            if (! ( - 1 >= this.collectTime) && (this.collectTime += ig.system.tick, !(0 > this.collectTime))) if (this.collectTime >= this.collectDuration) this.collectTime %= this.collectDuration,
            this.collectTime = -1,
            null != this.collectEndPos && (this.pos.x = this.collectEndPos.x, this.pos.y = this.collectEndPos.y);
            else {
                ...
                if (null != this.collectEndPos) {
                    ...
                    this.pos.y = this.collectStartPos.y + this.collectVector.y * a
                }
            }
        },
        ...
        updateDrop: function() {
            ...
            if (0 < a - this.pos.y) {
                if (this.dropVel += this.dropWeight * ig.system.tick, this.pos.y += this.dropVel, this.pos.y > a) if (2 >= this.dropVel) this.dropVel = 0,
                this.pos.y = a;
                else {
                    var b = this.pos.y - a;
                    this.dropVel *= -0.2;
        ...
        hit: function() {
            if ((! (id != this.states.despawn && id != this.states.dead) || !(this.stateId == this.states.despawn || this.stateId == this.states.dead)) && this.stateId != this.states.hit) this.setStateId(this.states.hit),
            this.hitEffectTime = 0,
            this.collectTime = -0.1,
            this.control.pickupHit(this)
        },
        idle: function() {
        ...
        onCollect: function() {},
        setStateId: function(a) {
            a != this.states.dead && (this.stateId == this.states.despawn || this.stateId == this.states.dead) || (this.prevStateId = this.stateId, this.stateId = a)
        },
        aabbCheck: function(a, b) {
            return a.x + a.w > b.x && a.x < b.x + b.w && a.y + a.h > b.y && a.y < b.y + b.h ? !0 : !1
        },
...
ig.module("game.classes.floating-text").defines(function() {
    FloatingText = ig.Class.extend({
        ...
        update: function() {
            this.disabled || (this.time += ig.system.tick, this.time > this.duration ? this.kill() : (this.time > this.duration - this.fadeDuration && (this.alpha = 1 - (this.time - (this.duration - this.fadeDuration)) / this.fadeDuration), this.scale = this.time <= this.growDuration ? this.time / this.growDuration: 1))
        },
        draw: function() {
        ...
        drawText: function() {
            ...
            c = c + this.vector.y * this.vel * this.time;
...
ig.module("game.classes.monster").requires("plugins.number-anim", "plugins.image-manipulation", "plugins.rumbler").defines(function() {
    Monster = ig.Class.extend({
        ...
        update: function() {
            this.control.gameOver || (this.health.update(), this.stateId == this.states.hit ? (this.updateAnim(this.hitAnim), this.updateHitEffect(), this.updateHit()) : this.stateId == this.states.dying ? (this.updateDying(), this.updateAnim(this.hitAnim), this.updateHitEffect()) : this.stateId == this.states.idle ? (this.updateAnim(this.idleAnim), this.updateBounce(), this.wanderDisabled || this.setStateId(this.states.wander)) : this.stateId == this.states.moveAttack ? (this.updateMoveAttack(), this.updateAnim(this.idleAnim), this.updateBounce()) : this.stateId == this.states.move ? (this.updateMove(), this.updateAnim(this.idleAnim), this.updateBounce()) : this.stateId == this.states.dropEntrance ? (this.updateDropEntrance(), this.updateAnim(this.idleAnim), this.updateHitEffect()) : this.stateId == this.states.wander ? this.wanderDisabled ? this.setStateId(this.states.idle) : (this.updateWander(), this.updateAnim(this.idleAnim), this.updateBounce()) : this.stateId == this.states.attack && (this.updateAnim(this.idleAnim), this.updateAttack()))
        },
        draw: function() {
            this.stateId == this.states.hit ? this.drawHit() : this.stateId == this.states.idle || this.stateId == this.states.attack || this.stateId == this.states.wander || this.stateId == this.states.move || this.stateId == this.states.moveAttack || this.stateId == this.states.dropEntrance ? this.drawIdle() : this.stateId == this.states.dying && this.drawDying()
        },
        drawShadow: function() {
            if (this.stateId != this.states.dead && !(0 >= this.shadowWidth)) {
                var a = ig.system.context,
        ...
        updateMove: function() {
            ...
            } else this.moveVector = null,
            this.setStateId(this.states.wander)
        },
        updateMoveAttack: function() {
            var a = this.control.hero;
            if (!a.stateId == a.states.dead && !a.stateId == a.states.dying) this.attackVector = null,
            this.setStateId(this.states.wander);
            else {
                ...
                this.attackVector.x = a.pos.x - this.pos.x, this.attackVector.y = a.pos.y - this.pos.y, this.attackVector.l = Math.sqrt(this.attackVector.x * this.attackVector.x + this.attackVector.y * this.attackVector.y), 0 < this.attackVector.l && (this.attackVector.x /= this.attackVector.l, this.attackVector.y /= this.attackVector.l), this.attackVector.p = 0, this.updateFacing());
        ...
        updateWander: function() {
            ...
            if (!this.attackDisabled && this.wanderTime.delta() >= this.wanderMaxDuration) this.setStateId(this.states.moveAttack),
            this.wanderDestination = this.wanderVector = this.wanderTime = null,
            this.wanderPauseTime = -1;
            else {
                if (0 <= this.wanderPauseTime) if (this.wanderPauseTime += ig.system.tick, this.wanderPauseTime > this.wanderPauseDuration) this.wanderPauseTime = -1;
                else return;
        ...
        updateDropEntrance: function() {
            if (this.dropToDestination) {
                null == this.dropVector && (this.dropVector = {
                    x: 0,
                    y: 0
                },
        ...
        updateAttack: function() {
            ...
            this.setStateId(this.states.wander);
                ...
                this.attackVector.x = a.pos.x - this.pos.x, this.attackVector.y = a.pos.y - this.pos.y, this.attackVector.l = Math.sqrt(this.attackVector.x * this.attackVector.x + this.attackVector.y * this.attackVector.y), 0 < this.attackVector.l && (this.attackVector.x /= this.attackVector.l, this.attackVector.y /= this.attackVector.l), this.attackPos = {
                    x: this.pos.x,
                    y: this.pos.y
                },
                ...
                c > this.attackDuration && (this.attackTime = new ig.Timer(this.attackRate - (c - this.attackDuration)), this.pos.x = this.attackPos.x, this.pos.y = this.attackPos.y, this.attackDamageDone = b = !1, this.attackOnce && (this.attackTime = this.attackVector = null, this.wanderDisabled = !0, this.setStateId(this.states.idle)));
                if (b) {
                    ...
                    this.pos.y = this.attackPos.y + b; ! this.attackDamageDone && 0.5 <= d && (this.attackDamageDone = !0, a.attackedByMonster(this))
                } else this.updateBounce()
            }
        },
        updateHit: function() {
            1 <= this.hitAnim.loopCount && (this.idleAnim.time = 0, this.updateAnim(this.idleAnim), this.prevStateId == this.states.wander ? (this.setStateId(this.states.wander), this.wanderDestination = this.wanderVector = this.wanderTime = null, this.wanderPauseTime = -1) : this.prevStateId == this.states.moveAttack ? this.setStateId(this.states.moveAttack) : this.prevStateId == this.states.move ? this.setStateId(this.states.move) : this.prevStateId == this.states.attack ? (this.setStateId(this.states.attack), this.attackVector = null, this.attackTime = new ig.Timer(this.attackRate)) : this.stateId = this.states.idle)
        },
        updateHitEffect: function() {
            0 > this.hitEffectTime || (this.hitEffectTime += ig.system.tick, this.hitEffectTime >= this.hitEffectDuration ? (this.hitEffectTime %= this.hitEffectDuration, this.hitEffectTime = -1, this.hitEffectAlpha = 1) : this.hitEffectAlpha = 1 - this.hitEffectTime / this.hitEffectDuration)
        },
        ...
        takeDamage: function(a) {
            this.stateId == this.states.dying || this.stateId == this.states.dead || (this.health.add( - a), 0 >= this.health.actualValue && (this.die(), this.setHitMode(2)), 0.5 > Math.random() ? this.setHitMode(1) : this.setHitMode(0))
        },
        moveTo: function(a) {
            a && (this.moveToDestination = {},
            this.moveToDestination.x = a.x, this.moveToDestination.y = a.y, this.moveVector = null, this.setStateId(this.states.move))
        },
        dropTo: function(a) {
            a && (this.dropToDestination = {},
            this.dropToDestination.x = a.x, this.dropToDestination.y = a.y, this.dropVector = null, this.pos.x = a.x, this.pos.y = -200, this.setStateId(this.states.dropEntrance))
        },
        hit: function() {
            this.stateId != this.states.dead && (this.stateId == this.states.attack && this.attackPos && (this.pos.x = this.attackPos.x, this.pos.y = this.attackPos.y), this.stateId != this.states.dying && this.stateId != this.states.dropEntrance && this.setStateId(this.states.hit), this.hitAnim.time = 0, this.updateAnim(this.hitAnim), this.hitEffectTime = 0)
        },
        idle: function() {
            this.stateId == this.states.dying || this.stateId == this.states.dead || (this.setStateId(this.states.idle), this.idleAnim.time = 0, this.updateAnim(this.idleAnim))
        },
        ...
        generateWanderDestination: function() {
            ...
            a.y = this.pos.y;
            0 < this.wanderRect.h && (b = this.pos.y - this.wanderRange, c = this.pos.y + this.wanderRange, c > this.wanderRect.y + this.wanderRect.h && (c = this.wanderRect.y + this.wanderRect.h), a.y = b + Math.random() * (c - b));
            return a
        },
        ...
        setStateId: function(a) {
            if (! (a != this.states.dying && a != this.states.dead) || !(this.stateId == this.states.dying || this.stateId == this.states.dead)) a != this.prevStateId && (this.prevStateId = this.stateId),
            this.stateId = a
        },
        aabbCheck: function(a, b) {
            return a.x + a.w > b.x && a.x < b.x + b.w && a.y + a.h > b.y && a.y < b.y + b.h ? !0 : !1
...
ig.module("game.classes.monsters.monster0").requires("game.classes.monster").defines(function() {
    Monster0 = Monster.extend({
        ...
        init: function(a) {
            ...
            this.control.hero && (a = this.control.hero.level, this.maxHealth += this.maxHealth * a * _STRINGS.UnitSpecs.monster_health_rate, this.damage += this.damage * a * _STRINGS.UnitSpecs.monster_damage_rate, this.moveSpeed += this.moveSpeed * a * _STRINGS.UnitSpecs.monster_move_speed_mult_rate, this.attackmoveSpeed += this.attackmoveSpeed * a * _STRINGS.UnitSpecs.monster_move_speed_mult_rate, this.wanderMoveSpeed += this.wanderMoveSpeed * a * _STRINGS.UnitSpecs.monster_move_speed_mult_rate, this.attackRate /= 1 + a * _STRINGS.UnitSpecs.monster_attack_speed_mult_rate);
            this.health.setMax(this.maxHealth);
            this.health.setValue(this.maxHealth)
        }
    })
...
ig.module("game.classes.monsters.monster1").requires("game.classes.monster").defines(function() {
    Monster1 = Monster.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster1/monster1_hit1_5x1.png", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster1/monster1_hit2_6x1.png", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster1/monster1_hit3_6x1.png", 92, 109)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster1/monster1_hit1_5x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster1/monster1_hit2_6x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster1/monster1_hit3_6x1.png#ff0000^screen", 92, 109)],
        pos: {
            x: 0,
            y: 0
        },
...
ig.module("game.classes.monsters.monster2").requires("game.classes.monster").defines(function() {
    Monster2 = Monster.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster2/monster2_hit1_4x1.png", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster2/monster2_hit2_7x1.png", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster2/monster2_hit3_5x1.png", 92, 109)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster2/monster2_hit1_4x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster2/monster2_hit2_7x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster2/monster2_hit3_5x1.png#ff0000^screen", 92, 109)],
        pos: {
            x: 0,
            y: 0
        },
...
ig.module("game.classes.monsters.monster3").requires("game.classes.monster").defines(function() {
    Monster3 = Monster.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster3/monster3_hit1_6x1.png", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster3/monster3_hit2_9x1.png", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster3/monster3_hit3_6x1.png", 92, 109)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster3/monster3_hit1_6x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster3/monster3_hit2_9x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster3/monster3_hit3_6x1.png#ff0000^screen", 92, 109)],
        pos: {
            x: 0,
            y: 0
        },
...
ig.module("game.classes.monsters.monster4").requires("game.classes.monster").defines(function() {
    Monster4 = Monster.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster4/monster4_hit1_9x1.png", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster4/monster4_hit2_9x1.png", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster4/monster4_hit3_13x1.png", 92, 109)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster4/monster4_hit1_9x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster4/monster4_hit2_9x1.png#ff0000^screen", 92, 109), new ig.AnimationSheet("media/game/graphics/game/sprites/monster/monster4/monster4_hit3_13x1.png#ff0000^screen", 92, 109)],
        pos: {
            x: 0,
            y: 0
        },
...
ig.module("game.classes.boss").requires("game.classes.monster").defines(function() {
    Boss = Monster.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss0/boss0_hit1_5x2.png", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss0/boss0_hit2_3x2.png", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss0/boss0_hit3_4x2.png", 318, 332)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss0/boss0_hit1_5x2.png#ff0000^screen", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss0/boss0_hit2_3x2.png#ff0000^screen", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss0/boss0_hit3_4x2.png#ff0000^screen", 318, 332)],
        ...
        updateBossAttack: function() {
            if (! (this.stateId == this.states.dying || this.stateId == this.states.dead || this.stateId == this.states.dropEntrance) && !this.timerDisabled && 0 <= this.attackTime) this.attackTime += ig.system.tick,
            this.attackTime > this.attackDuration && (this.attackTime = -1, this.attackDisabled || this.control.bossAttack())
        },
...
ig.module("game.classes.bosses.boss0").requires("game.classes.boss").defines(function() {
    Boss0 = Boss.extend({
        ...
        init: function(a) {
            ...
            this.control.hero && (a = this.control.hero.level, this.maxHealth += this.maxHealth * a * _STRINGS.UnitSpecs.boss_health_rate, this.attackDuration += this.attackDuration * a * _STRINGS.UnitSpecs.boss_attackduration_rate);
            this.health.setMax(this.maxHealth);
            this.health.setValue(this.maxHealth)
        },
        setIdleMode: function(a) {
...
ig.module("game.classes.bosses.boss1").requires("game.classes.boss").defines(function() {
    Boss1 = Boss.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss1/boss1_hit1_4x2.png", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss1/boss1_hit2_3x2.png", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss1/boss1_hit3_4x2.png", 318, 332)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss1/boss1_hit1_4x2.png#ff0000^screen", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss1/boss1_hit2_3x2.png#ff0000^screen", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss1/boss1_hit3_4x2.png#ff0000^screen", 318, 332)],
        idleAnimFramerate: 0.2,
        hitAnimFramerate: 0.05,
        pos: {
            x: 0,
...
ig.module("game.classes.bosses.boss2").requires("game.classes.boss").defines(function() {
    Boss2 = Boss.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss2/boss2_hit1_4x2.png", 245, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss2/boss2_hit2_4x2.png", 245, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss2/boss2_hit3_4x2.png", 245, 332)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss2/boss2_hit1_4x2.png#ff0000^screen", 245, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss2/boss2_hit2_4x2.png#ff0000^screen", 245, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss2/boss2_hit3_4x2.png#ff0000^screen", 245, 332)],
        idleAnimFramerate: 0.2,
        hitAnimFramerate: 0.05,
        pos: {
            x: 0,
...
ig.module("game.classes.bosses.boss3").requires("game.classes.boss").defines(function() {
    Boss3 = Boss.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss3/boss3_hit1_4x2.png", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss3/boss3_hit2_4x2.png", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss3/boss3_hit3_3x2.png", 318, 332)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss3/boss3_hit1_4x2.png#ff0000^screen", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss3/boss3_hit2_4x2.png#ff0000^screen", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss3/boss3_hit3_3x2.png#ff0000^screen", 318, 332)],
        idleAnimFramerate: 0.2,
        hitAnimFramerate: 0.05,
        pos: {
            x: 0,
...
ig.module("game.classes.bosses.boss4").requires("game.classes.boss").defines(function() {
    Boss4 = Boss.extend({
        ...
        hitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss4/boss4_hit1_3x2.png", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss4/boss4_hit2_5x2.png", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss4/boss4_hit3_4x2.png", 318, 332)],
        highlightHitAnimSheets: [new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss4/boss4_hit1_3x2.png#ff0000^screen", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss4/boss4_hit2_5x2.png#ff0000^screen", 318, 332), new ig.AnimationSheet("media/game/graphics/game/sprites/boss/boss4/boss4_hit3_4x2.png#ff0000^screen", 318, 332)],
        idleAnimFramerate: 0.2,
        hitAnimFramerate: 0.05,
        pos: {
            x: 0,
...
ig.baked = !0;
ig.module("game.entities.game-control").requires("impact.entity", "plugins.fade-transition", "plugins.number-anim", "game.classes.ui", "game.classes.tutorial", "game.classes.gameover-panel", "game.classes.shop-panel", "game.classes.options-panel", "game.classes.ability", "game.classes.character", "game.classes.pickup", "game.classes.hp-pickup", "game.classes.sp-pickup", "game.classes.power-pickup", "game.classes.slash", "game.classes.floating-text", "game.classes.monsters.monster0", "game.classes.monsters.monster1", "game.classes.monsters.monster2", "game.classes.monsters.monster3", "game.classes.monsters.monster4", "game.classes.bosses.boss0", "game.classes.bosses.boss1", "game.classes.bosses.boss2", "game.classes.bosses.boss3", "game.classes.bosses.boss4").defines(function() {
    EntityGameControl = ig.Entity.extend({
        ...
        draw: function() {
            ...
            a.save();
            1 != this.bgScale && a.scale(this.bgScale, 1);
            this.bgImage.draw(this.bgOffset.x + this.screenshakeOffset.x, this.bgOffset.y + this.screenshakeOffset.y);
            a.restore();
        ...
        showShop: function() { (!this.tutorial || this.tutorial.targetButton != this.ui.shopButton) && this.pause();
            this.shop.show();
        ...
        hideShop: function() {
            this.shop.hide();
            this.ui.optionsButton.enable(); (!this.tutorial || this.tutorial.targetButton == this.ui.shopButton) && this.ui.shopButton.enable();
            this.unpause()
        },
        ...
        drawHeroAndMonsters: function() {
            ...
            for (a = 0; a < this.monsters.length; a++) b = this.monsters[a],
            b.drawShadow();
            ...
            b.draw(),
            b.drawHealthBar();
            for (a = 0; a < this.pickups.length; a++) b = this.pickups[a],
            b.draw()
        },
        ...
        updateMonsterSpawns: function() {
            if (0 == this.monsterSpawnQueue.length) {
                ...
                if (a) {
                    if (!this.boss || this.boss.stateId == this.boss.states.dead) this.waveCount += 1,
                    this.addLevel(1);
                    this.waveTime = 0;
                    this.spawnMonsters();
                    if ((!this.boss || this.boss.stateId == this.boss.states.dead) && this.waveCount >= this.waveBossInterval) this.waveCount = 0,
                    this.spawnBoss()
                }
            } else {
                for (var b = [], c = 0; c < this.monsterSpawnQueue.length; c++) a = this.monsterSpawnQueue[c],
                null == a.time || 0 >= a.time ? a.monster && this.monsters.push(a.monster) : (a.time -= ig.system.tick, b.push(a));
        ...
        updateWhiteout: function() {
            if (this.whiteoutFlag) {
                ...
                a > b + this.whiteoutEndDelay ? this.whiteoutFlag = !1 : a < b / 4 ? this.whiteoutAlpha = a / (b / 4) : a < 2 * b / 4 ? this.whiteoutAlpha = 1 : a < 3 * b / 4 ? (this.whiteoutClearFlag || (this.whiteoutClearFlag = !0), this.whiteoutAlpha = 1 - (a - 2 * b / 4) / (b / 4)) : a < b && (this.whiteoutAlpha = 0)
            }
        },
        ...
        addHpPotion: function(a) {
            isNaN(a) || (this.abilities[0].count += 1)
        },
        ...
        setupAbilities: function() {
            ...
            a = new Ability(1);
            a.buyCost = _STRINGS.UnitSpecs.hero_potion_energy_goldcost;
        ...
        updateAbilities: function() {
            for (var a = 0; a < this.abilities.length; a++) this.abilities[a].update(),
            this.abilities[a].available = !0;
            this.hero.health.actualValue >= this.hero.maxHealth && (this.abilities[0].available = !1);
        ...
        upgradeAbility: function(a) {
            if (! (0 > a || a >= this.abilities.length)) if (a = this.abilities[a], !(a.buyCost > this.gameGold.actualValue)) if (this.addGameGold( - a.buyCost), a.count += 1, 3 == a.id) {
                var b = _STRINGS.UnitSpecs.hero_upgrade_damage_goldcost,
        ...
        spawnMonsterFromTop: function() {
            ...
            } else if (d = b, h = 100 + Math.random() * (ig.system.width - 200), j = this.groundLevel, a = Math.floor(Math.random() * d.length), d = d[a], d = this.makeMonster(d)) e = 1 + 2 * Math.random(),
            d.dropTo({
                x: h,
                y: j
            }),
        ...
        spawnMonsterFromRight: function() {
            ...
            c ? (d = a, h = ig.system.width - f + 100 + Math.random() * (f - 200), f = -100 + Math.random() * (100 + (this.groundLevel - 200)), j = 100 + Math.random() * (this.groundLevel - 200)) : (d = b, h = ig.system.width - f + 100 + Math.random() * (f - 200), j = f = this.groundLevel);
            a = Math.floor(Math.random() * d.length);
            d = d[a];
            if (d = this.makeMonster(d)) d.setPos({
                x: e,
        ...
        spawnPickup: function(a, b, c) {
            ...
            if (0 == d) {
                ...
                this.pickups.push(c)
            } else 1 == d ? (c = new HpPickup(this), c.pos.x = a, c.pos.y = b, c.spawnVector.x = -80 + 160 * Math.random(), c.spawnVector.y = -250 - 250 * Math.random(), c.collectEndPos = {},
            c.collectEndPos.x = this.ui.abilityButtonList[0].pos.x, c.collectEndPos.y = this.ui.abilityButtonList[0].pos.y, c.onCollect = function() {
                this.addHpPotion(1)
            }.bind(this), this.pickups.push(c)) : 2 == d ? (c = new SpPickup(this), c.pos.x = a, c.pos.y = b, c.spawnVector.x = -80 + 160 * Math.random(), c.spawnVector.y = -250 - 250 * Math.random(), c.collectEndPos = {},
            c.collectEndPos.x = this.ui.abilityButtonList[1].pos.x, c.collectEndPos.y = this.ui.abilityButtonList[1].pos.y, c.onCollect = function() {
                this.addSpPotion(1)
            }.bind(this), this.pickups.push(c)) : 3 == d && (c = new PowerPickup(this), c.pos.x = a, c.pos.y = b, c.spawnVector.x = -80 + 160 * Math.random(), c.spawnVector.y = -250 - 250 * Math.random(), c.collectEndPos = {},
            c.collectEndPos.x = this.ui.abilityButtonList[2].pos.x, c.collectEndPos.y = this.ui.abilityButtonList[2].pos.y, c.onCollect = function() {
        ...
        heroAttackPosition: function(a, b) {
            for (var c = !1,
            d = [], e = 0; e < this.monsters.length; e++) {
            ...
            0 == d.length && (this.boss && this.boss.stateId != this.boss.states.dying && this.boss.stateId != this.boss.states.dead) && (h = {
                x: 0,
                y: 0,
                w: 0,
                h: 0
            ...
            for (e = this.pickups.length - 1; 0 <= e; e--) if (c = this.pickups[e], c.stateId == c.states.spawn || c.stateId == c.states.idle) if (h = {
                x: 0,
                y: 0,
                w: 0,
                h: 0
...
ig.module("integrations.entities.branding-splash").requires("impact.impact", "impact.entity", "game.components.tween").defines(function() {
    EntityBrandingSplash = ig.Entity.extend({
        ...
        draw: function() {
            ig.global.wm ? ig.system.context.fillRect(this.pos.x, this.pos.x, this.size.x, this.size.y) : (ig.system.context.fillStyle = "#60a6d1", ig.system.context.fillRect(0, 0, ig.system.width, ig.system.height), ig.system.context.fillStyle = "#000", ig.system.context.font = "12px Arial", this.parent(), this.splash && ig.system.context.drawImage(this.splash.data, 0, 0, this.splash.data.width, this.splash.data.height, this.pos.x, this.pos.y, this.size.x, this.size.y))
        }
    })
});
